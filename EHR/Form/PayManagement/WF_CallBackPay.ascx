<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_CallBackPay.ascx.cs"
    Inherits="Zhongsoft.Portal.EHR.Form.PayManagement.WF_CallBackPay" %>
<table class="tz-table">
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox ID="tbTitle" runat="server" CssClass="kpms-textbox" Field="TITLE"
                Tablename="EHR_CALLBACKPAYFORM" Activestatus="(23.制作加班统计表)(3.修改加班统计表)" EnableTheming="false"
                req="1" MaxLength="128">
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText runat="server" ID="txtCreateMenName" readonly="readonly"
                class="kpms-textbox" field="CREATEMANNAME" tablename="EHR_CALLBACKPAYFORM" activestatus="(23.制作加班统计表)(3.修改加班统计表)" />
            <input type="hidden" id="hiCreateManID" runat="server" field="CREATEMANID" tablename="EHR_CALLBACKPAYFORM" />
            <input type="hidden" id="hiCreateManCode" runat="server" field="CREATEMANCODE" tablename="EHR_CALLBACKPAYFORM" />
        </td>
        <td class="td-l">
            联系电话
        </td>
        <td class="td-r">
            <zhongsoft:LightTextBox ID="tbCreateManPhone" runat="server" CssClass="kpms-textbox"
                Field="CREATEMANPHONE" Tablename="EHR_CALLBACKPAYFORM" Activestatus="(23.制作加班统计表)(3.修改加班统计表)"
                MaxLength="11">
            </zhongsoft:LightTextBox>
        </td>
        <td class="td-l">
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText runat="server" ID="txtCreateDeptName" readonly="readonly"
                class="kpms-textbox" field="CREATEDEPTNAME" tablename="EHR_CALLBACKPAYFORM" activestatus="(23.制作加班统计表)(3.修改加班统计表)" />
            <input type="hidden" id="hiCreateDeptID" runat="server" field="CREATEDEPTID" tablename="EHR_CALLBACKPAYFORM" />
            <input type="hidden" id="hiCreateDeptCode" runat="server" field="CREATEDEPTCODE"
                tablename="EHR_CALLBACKPAYFORM" />
        </td>
    </tr>
    <tr>
        <td class="td-l">
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText ID="txtCreateDocDate" runat="server" class="kpms-textbox-comparedate"
                field="CREATEDOCDATE" tablename="EHR_CALLBACKPAYFORM" readonly="readonly" req="1"
                activestatus="(23.制作加班统计表)(3.修改加班统计表)" compare="1" />
        </td>
        <td class="td-l">
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText ID="txtFinishDate" runat="server" class="kpms-textbox-comparedate"
                field="FINISHDATE" tablename="EHR_CALLBACKPAYFORM" readonly="readonly" req="1"
                activestatus="(23.制作加班统计表)(3.修改加班统计表)" compare="1" />
        </td>
        <td class="td-l">
            缓急程度
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlImpLevel" runat="server" field="PriorityLevel" tablename="EHR_CALLBACKPAYFORM">
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="tbMemo" TextMode="MultiLine" activestatus="(23.制作加班统计表)(3.修改加班统计表)"
                maxtext="1024" CssClass="kpms-textarea" EnableTheming="false" field="MEMO" tablename="EHR_CALLBACKPAYFORM" />
        </td>
    </tr>
    <tr>
    ...
    <tr runat="server" displaystatus="(3.制作加班统计表)(3.修改加班统计表)(3.审核加班统计表)">
        <td class="td-r" colspan="6" style="text-align: right !important;">
            <asp:LinkButton ID="lbkUpLoadFile" runat="server" DisplayStatus="(3.制作加班统计表)(3.修改加班统计表)(3.审核加班统计表)"
                Activestatus="(3.制作加班统计表)(3.修改加班统计表)(3.审核加班统计表)" OnClientClick="return upLoadFile(1)"
    ...
    <tr>
        <td colspan="6" align="center">
            <zhongsoft:LightPowerGridView ID="gvListFile" runat="server" ShowFooter="false" AllowPaging="false"
                ...
                BindGridViewMethod="UserControl.BindFile" DataKeyNames="FileId,FilePath" ShowEmptyDataHeader="true">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="文件名称" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="85%">
                        <ItemTemplate>
    ...
    <tr runat="server" displaystatus="(3.制作加班费发放表)">
        <td class="td-r" colspan="6" style="text-align: right !important;">
            <asp:LinkButton ID="lkbPayListUp" runat="server" DisplayStatus="(3.制作加班费发放表)" Activestatus="(3.制作加班费发放表)"
...
<input type="hidden" id="hiCallBackPayFormID" runat="server" field="CALLBACKPAYFORMID"
    tablename="EHR_CALLBACKPAYFORM" />
<input type="hidden" id="hiTJFILESORCEID" runat="server" field="TJFILESORCEID" tablename="EHR_CALLBACKPAYFORM" />
<input type="hidden" id="hiFFFILESORCEID" runat="server" field="FFFILESORCEID" tablename="EHR_CALLBACKPAYFORM" />

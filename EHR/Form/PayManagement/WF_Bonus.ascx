<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_Bonus.ascx.cs" Inherits="Zhongsoft.Portal.EHR.Form.PayManagement.WF_Bonus" %>
<table class="tz-table">
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox ID="tbTitle" runat="server" CssClass="kpms-textbox" Field="TITLE"
                Tablename="EHR_BONUS" Activestatus="(23.奖金发放通知)" EnableTheming="false" MaxLength="128"
                req="1">
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText runat="server" ID="txtCreateMenName" readonly="readonly"
                class="kpms-textbox" field="CREATEMANNAME" tablename="EHR_BONUS" activestatus="(23.奖金发放通知)" />
            <input type="hidden" id="hiCreateManID" runat="server" field="CREATEMANID" tablename="EHR_BONUS" />
            <input type="hidden" id="hiCreateManCode" runat="server" field="CREATEMANCODE" tablename="EHR_BONUS" />
        </td>
        <td class="td-l">
            联系电话
        </td>
        <td class="td-r">
            <zhongsoft:LightTextBox ID="tbCreateManPhone" runat="server" CssClass="kpms-textbox"
                Field="CREATEMANPHONE" Tablename="EHR_BONUS" Activestatus="(23.奖金发放通知)" MaxLength="11">
            </zhongsoft:LightTextBox>
        </td>
        <td class="td-l">
            拟稿部门
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText runat="server" ID="txtCreateDeptName" readonly="readonly"
                class="kpms-textbox" field="CREATEDEPTNAME" tablename="EHR_BONUS" activestatus="(23.奖金发放通知)" />
            <input type="hidden" id="hiCreateDeptID" runat="server" field="CREATEDEPTID" tablename="EHR_BONUS" />
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText ID="txtCreateDocDate" runat="server" class="kpms-textbox-comparedate"
                field="CREATEDOCDATE" tablename="EHR_BONUS" readonly="readonly" req="1" activestatus="(23.奖金发放通知)"
                compare="1" />
        </td>
        <td class="td-l">
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText ID="txtFinishDate" runat="server" class="kpms-textbox-comparedate"
                field="FINISHDATE" tablename="EHR_BONUS" readonly="readonly" req="1" activestatus="(23.奖金发放通知)"
                compare="1" />
        </td>
        <td class="td-l">
            缓急程度
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlImpLevel" runat="server" field="PriorityLevel" tablename="EHR_BONUS">
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="tbMemo" TextMode="MultiLine" activestatus="(23.奖金发放通知)"
                maxtext="1024" CssClass="kpms-textarea" EnableTheming="false" field="MEMO" tablename="EHR_BONUS" />
        </td>
    </tr>
    <tr>
    ...
    <tr id="Tr1" runat="server" displaystatus="(3.制作奖金发放表)(3.审核奖金发放表)">
        <td class="td-r" colspan="6" style="text-align: right !important;">
            <asp:LinkButton ID="lbkUpLoadFile" runat="server" DisplayStatus="(3.制作奖金发放表)(3.审核奖金发放表)"
                Activestatus="(3.制作奖金发放表)(3.审核奖金发放表)" OnClientClick="return upLoadFile(1)" OnClick="lbkUpLoadFile_Click"
    ...
    <tr id="Tr2" runat="server" displaystatus="(3.薪酬福利岗汇总审核)(3.薪酬管理岗打印发放表)">
        <td class="td-r" colspan="6" style="text-align: right !important;">
            <asp:LinkButton ID="lkbPayListUp" runat="server" DisplayStatus="(3.薪酬福利岗汇总审核)(3.薪酬管理岗打印发放表)"
                Activestatus="(3.薪酬福利岗汇总审核)(3.薪酬管理岗打印发放表)" EnableTheming="false" OnClientClick="return upLoadFile(2)"
...
<input type="hidden" id="hiBONUSID" runat="server" field="BONUSID" tablename="EHR_BONUS" />
<input type="hidden" id="hiTJFILESORCEID" runat="server" field="TJFILESORCEID" tablename="EHR_BONUS" />
<input type="hidden" id="hiFFFILESORCEID" runat="server" field="FFFILESORCEID" tablename="EHR_BONUS" />
        ...
        if ($formAction == 0) {
            if ($actName == "制作奖金发放表") {
                if ($('#<%=gvListFile.ClientID %>')[0].rows[1].cells[0].innerText == "没有要查找的数据") {
                    window.alert('请上传奖金统计表！');
                    return false;
                }
            } else if ($actName == "薪酬福利岗汇总审核") {
                if ($('#<%=gvPayList.ClientID %>')[0].rows[1].cells[0].innerText == "没有要查找的数据") {
                    window.alert('请上传奖金发放表！');
                    return false;
                }
            }
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExternalAttendanceList.aspx.cs"
    Inherits="Zhongsoft.Portal.EHR.List.SalaryManagement.ExternalAttendanceList"
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView AllowPaging="true" PageSize="15" ID="gvList" UseDefaultDataSource="true"
        runat="server" ShowExport="true" HideFieldOnExport="查看" DataKeyNames="EXTERNALATTENDANCEFORMID"
        BindGridViewMethod="BindDataGrid" AllowFrozing="true" FrozenColNum="2">
        <Columns>

<%@ Page Title="部门信息" Language="C#" MasterPageFile="~/UI/Master/ObjectEditor.Master"
    AutoEventWireup="true" CodeBehind="OrganizationEditor.aspx.cs" Inherits="Zhongsoft.Portal.EHR.List.Organization.OrganizationEditor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BusinessObjectHolder" runat="server">
    ...
    <table class="tz-table">
        <tr>
            <td class="td-l">部门编号<span class="req-star">*</span>
            </td>
            <td class="td-r">
            ...
            <td class="td-l">部门名称<span class="req-star">*</span>
            </td>
            <td class="td-r">
        ...
        <tr id="trType" runat="server">
            <td class="td-l">部门分类<span class="req-star">*</span>
            </td>
            <td class="td-r">
        ...
        <tr>
            <td class="td-l">部门等级<span class="req-star">*</span>
            </td>
            <td class="td-r">
            ...
            <td class="td-l">上级部门<span runat="server" id="spanStar" class="req-star">*</span>
            </td>
            <td class="td-r">
        ...
        <tr>
            ...
            <td class="td-l">
                <asp:RadioButtonList runat="server" ID="rblRtx" RepeatDirection="Horizontal"  TableName="OrganizationOfficial" Field="IsSyncRTX">
                </asp:RadioButtonList>
            </td>
...
if(level=="2"){
var json = { OrganizationLevel: (level - 1),Department:"1" };
}else{

<%@ Page Title="培训总结台账" Language="C#" MasterPageFile="~/UI/Master/ObjectList.Master" AutoEventWireup="true" CodeBehind="OutTrainSummaryList.aspx.cs" Inherits="Zhongsoft.Portal.EHR.List.TrainManagement.OutTrainSummaryList" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView ID="gvList" runat="server" AutoGenerateColumns="false" AllowPaging="true" DataKeyNames="OutTrainFormID"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField HeaderText="培训总结" DataField="Summary" ShowToolTip="true" SortExpression="Summary">
            </zhongsoft:LightBoundField>

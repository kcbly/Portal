<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnplanedTrainProjectApplyEditor.aspx.cs"
    Inherits="Zhongsoft.Portal.EHR.List.TrainManagement.UnplanedTrainProjectApplyEditor"
...
<asp:Content ID="Content1" ContentPlaceHolderID="BusinessObjectHolder" runat="server">
        ...
        <tr>
            ...
            <td class="td-r">
                <zhongsoft:LightTextBox runat="server" ID="tbPeriod" CssClass="kpms-textbox" regex="^\d{1,3}$"
                    errmsg="请输入正确期数(1-3位整数)" req="1" field="PERIOD" tablename="EHR_YEARINSTTRAINPLANDT"
                    activestatus="(23.*)">
                </zhongsoft:LightTextBox>
            </td>
            <td class="td-l">
            ...
            <td class="td-r">
                <zhongsoft:XHtmlInputText ID="txtPlanStDate" runat="server" readonly="readonly" field="PLANSTDATE"
                    class="kpms-textbox-comparedate" compare="1" tablename="EHR_YEARINSTTRAINPLANDT"
            ...
            <td class="td-r">
                <zhongsoft:XHtmlInputText ID="txtPlanEndDate" runat="server" readonly="readonly"
                    field="PLANENDDATE" class="kpms-textbox-comparedate" compare="1" tablename="EHR_YEARINSTTRAINPLANDT"
                    req="1" activestatus="(23.*)" />
            </td>
        </tr>
        <tr>
            ...
            <td class="td-m" colspan="7">
                <zhongsoft:LightTextBox runat="server" ID="tbTrainProName" CssClass="kpms-textbox"
                    Width="99%" req="1" MaxLength="64" field="TRAINPROJECTNAME" tablename="EHR_YEARINSTTRAINPLANDT"
                    activestatus="(23.*)">
                </zhongsoft:LightTextBox>
            </td>
        </tr>
        <tr>
            ...
            <td class="td-m" colspan="7">
                <zhongsoft:LightTextBox runat="server" ID="tbTrainObject" CssClass="kpms-textbox"
                    EnableTheming="false" MaxLength="20" field="TRAINOBJECT" tablename="EHR_YEARINSTTRAINPLANDT"
        ...
        <tr>
            ...
            <td class="td-m" colspan="7">
                <zhongsoft:LightTextBox runat="server" ID="tbTrainContent" CssClass="kpms-textarea"
                    ...
                    tablename="EHR_YEARINSTTRAINPLANDT" activestatus="(23.*)" Width="99%">
                </zhongsoft:LightTextBox>
            </td>
        </tr>
        <tr>
            ...
            <td class="td-r">
                <zhongsoft:LightDropDownList runat="server" ID="ddlTrainWay" req="1" activestatus="(23.*)"
                    field="TRAININGWAY" tablename="EHR_YEARINSTTRAINPLANDT" Width="70px">
                </zhongsoft:LightDropDownList>
            </td>--%>
            <td class="td-l">
            ...
            <td class="td-r">
                <zhongsoft:LightDropDownList runat="server" ID="ddlTrainClass" req="1" activestatus="(23.*)"
                    field="TRAININGCLASS" tablename="EHR_YEARINSTTRAINPLANDT">
                </zhongsoft:LightDropDownList>
            </td>
            <td class="td-l">
            ...
            <td class="td-r">
                <zhongsoft:LightDropDownList runat="server" ID="ddlTrainingLevel" req="1" activestatus="(23.*)"
                    field="TRAININGLEVEL" tablename="EHR_YEARINSTTRAINPLANDT">
                </zhongsoft:LightDropDownList>
            </td>
            <%-- <td class="td-l">
            ...
            <td class="td-m" colspan="3">
                <zhongsoft:LightTextBox runat="server" ID="tbSourceOfTeachers" CssClass="kpms-textbox"
                    MaxLength="64" field="SOURCEOFTEACHERS" tablename="EHR_YEARINSTTRAINPLANDT" Width="98%"
                    activestatus="(23.*)">
                </zhongsoft:LightTextBox>
            </td>
        </tr>
        <%-- <tr>
            ...
            <td class="td-m" colspan="3">
                <zhongsoft:LightTextBox runat="server" ID="tbCourseWareSource" CssClass="kpms-textbox"
                    MaxLength="64" field="COURSEWARESOURCE" tablename="EHR_YEARINSTTRAINPLANDT"
        ...
        <tr>
            ...
            <td class="td-r">
                <zhongsoft:LightTextBox runat="server" ID="tbTrainClassHour" CssClass="kpms-textbox"
                    ...
                    field="TRAININGCLASSHOUR" tablename="EHR_YEARINSTTRAINPLANDT" activestatus="(23.*)">
                </zhongsoft:LightTextBox>
            </td>
            <td class="td-l">
            ...
            <td class="td-r">
                <zhongsoft:LightTextBox runat="server" ID="tbNumberOfTrain" CssClass="kpms-textbox"
                    errmsg="请输入正确的培训人数(1-4位整数)" regex="^\d{1,4}$" field="NUMBEROFTRAINING" tablename="EHR_YEARINSTTRAINPLANDT"
            ...
            <td class="td-m" colspan="3">
                <zhongsoft:LightTextBox runat="server" ID="tbAssessment" CssClass="kpms-textbox"
                    Width="98%" MaxLength="64" field="ASSESSMENT" tablename="EHR_YEARINSTTRAINPLANDT"
                    activestatus="(23.*)">
                </zhongsoft:LightTextBox>
            </td>
        </tr>
        <tr>
            ...
            <td class="td-r">
                <zhongsoft:LightTextBox runat="server" ID="tbCostEstimating" CssClass="kpms-textbox-money"
                    ...
                    field="COSTESTIMATING" tablename="EHR_YEARINSTTRAINPLANDT" activestatus="(23.*)">
                </zhongsoft:LightTextBox>
            </td>
            <td class="td-l">
            ...
            <td class="td-r" style="width: 50px">
                <zhongsoft:LightObjectSelector runat="server" ID="selUnderTaker" field="UNDERTAKERNAME"
                    tablename="EHR_YEARINSTTRAINPLANDT" activestatus="(23.*)" DoCancel="true" req="1"
                ...
                <input type="hidden" id="hiUnderTakerId" runat="server" field="UNDERTAKERID" tablename="EHR_YEARINSTTRAINPLANDT" />
            ...
            <td class="td-r">
                <zhongsoft:LightDropDownList runat="server" ID="ddlUnderDept" req="1" activestatus="(23.*)"
                    field="UNDERDEPTID" tablename="EHR_YEARINSTTRAINPLANDT" AutoPostBack="true" OnSelectedIndexChanged="ddlUnderDeptIndexChange">
                </zhongsoft:LightDropDownList>
            ...
            <td class="td-r" style="width: 50px">
                <zhongsoft:LightObjectSelector runat="server" ID="selLearder" field="LEADERNAME"
                    tablename="EHR_YEARINSTTRAINPLANDT" activestatus="(23.*)" DoCancel="true" ResultAttr="name"
                    EnableTheming="false" ShowJsonRowColName="true" ShowAttrs="name,UserCode" ResultForControls="{'hiLeaderId':'id'}"
                    PageUrl="~/Sys/OrgUsers/UserSelectorJson.aspx"></zhongsoft:LightObjectSelector>
                <input type="hidden" id="hiLeaderId" runat="server" field="LEADERID" tablename="EHR_YEARINSTTRAINPLANDT" />
            </td>--%>
        </tr>
        <tr>
            <td class="td-l">
    ...
    <input type="hidden" runat="server" id="hiType" field="TYPE" value="计划外" tablename="EHR_YEARINSTTRAINPLANDT" />
    <input type="hidden" runat="server" id="hiUnplanedTrainProjectApplyDtId" field="YEARINSTTRAINPLANDTID"
        tablename="EHR_YEARINSTTRAINPLANDT" />

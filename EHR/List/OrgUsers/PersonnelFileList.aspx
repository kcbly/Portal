<%@ Page Language="C#" Title="人事档案" AutoEventWireup="true" CodeBehind="PersonnelFileList.aspx.cs" Inherits="Zhongsoft.Portal.EHR.List.OrgUsers.PersonnelFileList" MasterPageFile="~/UI/Master/ObjectWhList.Master" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <script type="text/javascript">
        ...
        $KeyUrl = "/EHR/List/OrgUsers/PersonnelFileEditor.aspx";
        $isFlow = "0";

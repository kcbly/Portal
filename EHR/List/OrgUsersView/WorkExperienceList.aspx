<%@ Page Title="工作履历台账" Language="C#" MasterPageFile="~/UI/Master/ObjectList.Master" AutoEventWireup="true" CodeBehind="WorkExperienceList.aspx.cs" Inherits="Zhongsoft.Portal.EHR.List.OrgUsersView.WorkExperienceList" %>
...
<%--            <zhongsoft:LightCheckField HeaderText="全选" HeaderStyle-Width="60px" OnClientClick="checkGridViewRow">
            ...
            <zhongsoft:LightBoundField HeaderText="姓名" DataField="UserName" EditItemClick="ViewItem" DataParamFields="WORKEXPERIENCEID" />
    ...
    <script type="text/javascript">
        ...
        function ViewItem(bzid) {
            var url = "<%=WebAppPath %>" + "/EHR/List/OrgUsers/WorkExperienceEditor.aspx?&actionType=1&bizId=" + bzid;

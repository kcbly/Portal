<%@ Page Language="C#" AutoEventWireup="true" Title="日常费用报销申请台帐" MasterPageFile="~/UI/Master/ObjectList.Master"
    CodeBehind="OtherExpenseList.aspx.cs" Inherits="Zhongsoft.Portal.FM.List.Manage.OtherExpenseList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView ID="gvList" runat="server" UseDefaultDataSource="true" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" BindGridViewMethod="BindData"
        ShowExport="true" ShowPageSizeChange="true" DataKeyNames="OtherExpenseFormId" PageSize="15">
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="ExpenseNo" HeaderText="报销单号"  HeaderStyle-Width="5%" EditItemClick="ViewFlow" DataParamFields="OtherExpenseFormId" />
            <zhongsoft:LightBoundField DataField="ApplyUserName" HeaderText="经办人" HeaderStyle-Width="5%" />
            <zhongsoft:LightBoundField DataField="ApplyDeptName" HeaderText="部门" HeaderStyle-Width="5%" />
            <zhongsoft:LightBoundField DataField="ExpenseMoney" HeaderText="报销金额（小写）" HeaderStyle-Width="5%" />

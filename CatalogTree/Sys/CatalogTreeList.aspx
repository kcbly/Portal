...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <script type="text/javascript">
        function DesignClassfiedItem(bizId, actionType) {
            var stringFeatures = "dialogHeight:300px; dialogWidth: 600px; dialogTop: px; dialogLeft: px; edge:Raised; center: Yes; help: Yes; resizable: Yes; scroll:auto; status: no;";
            var url = "";
            if (actionType == "2") {
                url = "/Portal/CatalogTree/Sys/CatalogTreeEditor.aspx?actionType=" + actionType;
            }
            else {
                url = "/Portal/CatalogTree/Sys/CatalogTreeEditor.aspx?actionType=" + actionType + "&bizId=" + bizId;
            }
            url += "&type=" +"<%=TreeType %>";

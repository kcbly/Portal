<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TSMFileTree.aspx.cs"
    Inherits="Zhongsoft.Portal.DCMS.List.TSMFileTree" %>
...
<body>
    ...
    <div>
        ...
        <input type="hidden" runat="server" id="hiPageSize" value="10" />
                    ...
                    <td width="20%" valign="top" style="border: 1px #6699FF solid;" id="tdTree">
                        <div id="prolefttree" style="padding: 0px; margin: 0px; width: 270px; overflow: auto; vertical-align:top;
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <asp:DropDownList runat="server" ID="ddltype" Visible="false" Style="background-color: White;width:70px">
                                        </asp:DropDownList>
                                        项目名称/编号
    ...
    <script type="text/javascript">
        ...
        function getUrl(treeId, treeNode) {
            ...
            return "TSMFileTree.aspx?keyword=" + encodeURI($hikeyword.val()) + "&secid=" + secid + "&type=" + typeValue + "&projectPhaseEntityID=" + '<%=OrganizationID %>';
        }
        ...
        $(document).ready(function () {
            ...
            $.post("TSMFileTree.aspx?organizationID=" + '<%=OrganizationID %>',
                       { asyfunc: "GetProject" },
                           function (res) {
        ...
        function searchTree() {
            ...
            if (word != "") {
                $hikeyword.val(word);
                $.fn.zTree.destroy("treeDemo");
                $.post("TSMFileTree.aspx?secid=" + secid + "&type=" + typeValue + "&organizationID=" + '<%=OrganizationID %>',

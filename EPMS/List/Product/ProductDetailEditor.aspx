<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductDetailEditor.aspx.cs"
    Title="成品详细信息" MasterPageFile="~/UI/Master/ObjectEditor.Master" Inherits="Zhongsoft.Portal.EPMS.List.Product.ProductDetailEditor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BusinessObjectHolder" runat="server">
                                                ...
                                                <div style="overflow-y: auto; max-height: 440px;">
                                                    <zhongsoft:LightPowerGridView runat="server" Width="100%" ID="gvProductList" AllowPaging="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <zhongsoft:LightTemplateField HeaderText="成品名称" ItemStyle-Width="120px">
                                                                <ItemTemplate>
                                                                    <div style="word-break: break-all!important; white-space: normal!important;">
                                                                        <%#Eval("ProductName")%>
                                                                    </div>
                                                            ...
                                                            <zhongsoft:LightTemplateField HeaderText="压力管道<br/>级别">
                                                                <ItemTemplate>
                                                ...
                                                <div style="overflow-y: auto; max-height: 440px;">
                                                    <zhongsoft:LightPowerGridView runat="server" Width="100%" ID="gvTextList" AllowPaging="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <zhongsoft:LightTemplateField HeaderText="格式" ItemStyle-Width="55px">
                                                                <ItemTemplate>
                                                                    <zhongsoft:LightDropDownList runat="server" ID="ddlFileFormat" OnSelectedIndexChanged="ddlFileFormat_OnSelectedIndexChanged" AutoPostBack="True">
                                                                    </zhongsoft:LightDropDownList>
                                                                </ItemTemplate>
                                                            </zhongsoft:LightTemplateField>
                                                    ...
                                                    <zhongsoft:LightPowerGridView ID="gvSignList" runat="server" AllowPaging="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <zhongsoft:LightTemplateField HeaderText="会签人" ItemStyle-Width="150">
                                                                <ItemTemplate>
                                                                    <zhongsoft:LightObjectSelector runat="server" ID="txtSignerInfo" IsMutiple="true" flag="update"
                                                                        ShowSelectBtn="true" EnableTheming="false" SourceMode="SelectorPage" ShowJsonRowColName="true"
                                                                        ...
                                                                        AfterSelect="setReturnVal()" PageWidth="850" ToolTip="选择会签人" title="选择会签人"></zhongsoft:LightObjectSelector>
                                                                </ItemTemplate>
                                                            </zhongsoft:LightTemplateField>
    ...
    <script type="text/javascript">
        ...
        function addSignSpe() {
            ...
            var json = { SelectFlag: '1', OrganizationID:'<%=OrganizationID %>', CurSpeId:'<%=WBS.BelongSpecialtyID %>' };
            var url = buildQueryUrl("EPMS/Obsolete/SignSpecSelector.aspx", json);

...
<asp:Content ID="Content2" ContentPlaceHolderID="toolBar" runat="server">
    <span class="filter-block"><span class="filter-block-lb">项目编号/名称</span> <span>
        ...
        </span></span><span class="filter-block"><span class="filter-block-lb">是否具备校审条件</span><span>
        ...
        </span></span><span class="filter-block"><span class="filter-block-lb">是否允许</span><span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvVerifyRoll" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField HeaderText="所属部室" DataField="BelongDeptName">
            </zhongsoft:LightBoundField>
            ...
            <zhongsoft:LightTemplateField HeaderText="是否具备<br/>校审条件" ItemStyle-Width="30px">
                <ItemTemplate>
            ...
            <zhongsoft:LightTemplateField HeaderText="是否允许" ItemStyle-Width="30px">
                <ItemTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryQualityInfoBySpecialtyList.aspx.cs"
    Inherits="Zhongsoft.Portal.EPMS.List.Quality.QueryQualityInfoBySpecialtyList"
...
<span class="filter-block"><span class="filter-block-lb">设计阶段</span><span>
    ...
    </span></span><span class="filter-block"><span class="filter-block-lb">校审完成时间</span>
        <span>
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvSpeQuality" AutoGenerateColumns="false"
        ShowExport="true" HideFieldOnExport="全部" runat="server" BindGridViewMethod="BindDataGrid"
        UseDefaultDataSource="true" ShowPageSizeChange="true" OnRowDataBound="gvSpeQuality_RowDataBound"
        PageSize="10" ShowFooter="true" OnRowCreated="gvSpeQuality_RowCreated" Width="100%"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField HeaderText="活用图<br/>率" DataField="AverageActiveRate" ItemStyle-HorizontalAlign="Right">
            </zhongsoft:LightBoundField>
        </Columns>

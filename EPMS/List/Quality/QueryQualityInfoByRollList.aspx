...
<span class="filter-block"><span class="filter-block-lb">设计阶段</span><span>
    ...
    </span></span><span class="filter-block"><span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvRollQuality" AutoGenerateColumns="false"
        ...
        UseDefaultDataSource="false" ShowPageSizeChange="true" OnRowDataBound="gvRollQuality_RowDataBound"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="WBSName" HeaderText="卷册名称" DataParamFields="WBSID"
            ...
            <zhongsoft:LightBoundField HeaderText="室评" DataField="RQualityLevel">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField HeaderText="院评" DataField="YQualityLevel">
            </zhongsoft:LightBoundField>

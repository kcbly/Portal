<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RollFileBag.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.WBS.RollFileBag"
    MasterPageFile="~/UI/Master/ObjectEditor.Master" Title="卷册档案袋" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BusinessObjectHolder" runat="server">
    <table class="tz-table" width="100%">
        ...
        <tr>
            <td class="flexible" colspan="6">卷册设计输入
            </td>
        </tr>
        <tr>
            <td colspan="6">
        ...
        <tr>
            <td class="flexible" colspan="6">卷册设计输出
            </td>
        </tr>
        <tr>
            <td colspan="6">
            ...
            <td colspan="6">
                <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvSurveryTask" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <zhongsoft:LightBoundField DataField="ExecSpecialtyName" HeaderText="卷册所在专业" ShowToolTip="true"
                            HeaderStyle-Width="180px">
                        </zhongsoft:LightBoundField>
        ...
        <tr>
            <td class="flexible" onclick="openDetail('inUpgradeRollList')" colspan="6" style="display: none">内审版卷册档案袋&nbsp;<img src="<%=WebAppPath%>/themes/images/lright.png" />
            </td>
        </tr>
        ...
        <tr>
            <td class="flexible" onclick="openDetail('rollVersionList')" colspan="6">卷册版本&nbsp;<img src="<%=WebAppPath%>/themes/images/lright.png" />
            </td>
        </tr>

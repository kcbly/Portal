...
<asp:Content ID="Content4" ContentPlaceHolderID="toolBtn" runat="server">
    ...
    <asp:LinkButton ID="lbtnStartWF" runat="server" EnableTheming="false" CssClass="btn-query"
        OnClientClick="return startWF()"><span>发起互提资料提交流程</span></asp:LinkButton>
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="toolBar" runat="server">
    ...
    </span></span><span class="filter-block"><span class="filter-block-lb">提出卷册名称/编号</span>
        <span>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvWBS" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField HeaderText="提资卷册编号" DataField="RollCode" SortExpression="RollCode">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField HeaderText="提资卷册名称" DataField="RollName" SortExpression="RollName">
            </zhongsoft:LightBoundField>
    ...
    <script type="text/javascript">
        ...
        //发起流程
        function startWF() {
            var $gridCheckedClientID = "<%=this.gvWBS.CheckedClientID %>";
            var checkValue = $("#" + $gridCheckedClientID).val();
            var url = "";
            var wbsID = "";

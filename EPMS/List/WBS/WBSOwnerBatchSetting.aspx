<%@ Page Title="批量安排卷册负责人" Language="C#" MasterPageFile="~/UI/Master/ObjectEditor.Master" AutoEventWireup="true" CodeBehind="WBSOwnerBatchSetting.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.WBS.WBSOwnerBatchSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BusinessObjectHolder" runat="server">
    ...
    <br />
    <span class="req-star">勾选需要安排的卷册，点击左上角“保存”按钮，批量安排卷册负责人、校核人。</span>
    <table class="tz-table">
        <tr>
            <td class="td-l">卷册名称/编号</td>
            <td class="td-m" colspan="4">
            ...
            <td colspan="6" class="td-m">
                <zhongsoft:LightPowerGridView runat="server" ID="gvList" UseDefaultDataSource="True" AllowPaging="True" PageSize="10" DataKeyNames="WBSID" BindGridViewMethod="BindData">
                    <Columns>
                        ...
                        <zhongsoft:LightBoundField HeaderText="卷册编号" HeaderStyle-Width="15%" DataField="WBSCode" />
                        <zhongsoft:LightBoundField HeaderText="卷册名称" HeaderStyle-Width="50%" DataField="WBSName" ShowToolTip="True" Width="350px" />
                        <zhongsoft:LightBoundField HeaderText="卷册负责人" HeaderStyle-Width="15%" DataField="SJR" />

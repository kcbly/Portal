...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvWBS" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField HeaderText="定额工日" DataField="WorkDayOfConfirm" SortExpression="WorkDayOfConfirm"
            ...
            <zhongsoft:LightBoundField HeaderText="实际送出版时间" DataField="VerifyEndDate" SortExpression="VerifyEndDate"
                DataFormatString="{0:yyyy-MM-dd}">
            </zhongsoft:LightBoundField>

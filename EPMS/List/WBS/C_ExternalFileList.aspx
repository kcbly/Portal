    ...
    <div style="overflow-y: auto; overflow-x: auto; max-height: 450px;">
        <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvWBS" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <zhongsoft:LightBoundField HeaderText="卷册编号" DataField="RollCode" SortExpression="RollCode" Width="60px" Visible="false">
                </zhongsoft:LightBoundField>
                <zhongsoft:LightBoundField HeaderText="卷册名称" DataField="RollName" SortExpression="RollName" Visible="false">
                </zhongsoft:LightBoundField>

...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvProjStatistics" AutoGenerateColumns="false" AllowFrozing="true" FrozenColNum="4" FrozenHeight="430px"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField HeaderText="部门/专业" DataField="DeptName">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField HeaderText="卷册数" DataField="RollCount" ItemStyle-HorizontalAlign="Right">

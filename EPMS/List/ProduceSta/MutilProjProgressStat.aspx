...
<asp:Content ID="Content4" ContentPlaceHolderID="toolBar" runat="server">
    ...
    </span></span><span class="filter-block"><span class="filter-block-lb">交出类型</span> <span>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="true"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="ManagerUserName" HeaderText="工程设总">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="BusinessType" HeaderText="类别" >
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="AllWorkDay" HeaderText="合计" ItemStyle-HorizontalAlign="Right">
            </zhongsoft:LightBoundField>
            ...
            <zhongsoft:LightBoundField DataField="LastWorkDay" HeaderText="剩余" ItemStyle-HorizontalAlign="Right">
            </zhongsoft:LightBoundField>

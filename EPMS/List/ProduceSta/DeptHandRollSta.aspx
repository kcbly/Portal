...
<asp:Content ID="Content4" ContentPlaceHolderID="toolBar" runat="server">
    <span class="filter-block"><span class="filter-block-lb">项目名称/编号</span> <span>
        <zhongsoft:LightObjectSelector runat="server" ID="txtProjectName" SourceMode="SelectorPage"
            ...
            PageWidth="850" ResultForControls="{'hiOrganizationID':'id'}"></zhongsoft:LightObjectSelector>
...
<asp:Content ID="Content5" ContentPlaceHolderID="advSearch" runat="server">
    ...
    </span></span><span class="filter-block"><span class="filter-block-lb">所属类型</span><span>
        <zhongsoft:LightDropDownList runat="server" ID="ddlRollType" class="kpms-ddlsearch">
        </zhongsoft:LightDropDownList>
    </span></span><span class="filter-block"><span class="filter-block-lb">日期范围</span> <span>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvProjStatistics" AutoGenerateColumns="false"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField HeaderText="校核人" DataField="OperatorName">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField HeaderText="主设人" DataField="主设人">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField HeaderText="主任工" DataField="主任工">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField HeaderText="室交出" DataField="FactRecheckTime1" DataFormatString="{0:yyyy-MM-dd}">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField HeaderText="部交出" DataField="FactRecheckTime2" DataFormatString="{0:yyyy-MM-dd}">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField HeaderText="院交出" DataField="FactDeliveryTime" DataFormatString="{0:yyyy-MM-dd}">
            </zhongsoft:LightBoundField>
            ...
            <zhongsoft:LightBoundField HeaderText="定额工日" DataField="WorkDayOfConfirm" ItemStyle-HorizontalAlign="Right">
                <FooterStyle HorizontalAlign="Right" />
            </zhongsoft:LightBoundField>
        </Columns>

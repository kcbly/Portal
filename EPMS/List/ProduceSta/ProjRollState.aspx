<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/Master/ObjectList.Master"
    Title="项目卷册状态查询" CodeBehind="ProjRollState.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.ProduceSta.ProjRollState" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="toolBar" runat="server">
    ...
    </span></span><span class="filter-block"><span>卷册状态</span><span>
    ...
    <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="true"
        ...
        <Columns>
            ...
            <zhongsoft:LightTemplateField HeaderText="出版状态">
                <ItemTemplate>
                    <%# Enum.GetName(typeof(DAL.EPMS.PublishState), Eval("PublishState") != DBNull.Value ?Eval("PublishState") :0 )%>
                </ItemTemplate>
            </zhongsoft:LightTemplateField>
            <zhongsoft:LightTemplateField HeaderText="交付状态">
                <ItemTemplate>
                    <%# Enum.GetName(typeof(DAL.EPMS.DeliveryState), Eval("DeliveryState") != DBNull.Value ?Eval("DeliveryState"):0 )%>
                </ItemTemplate>
            </zhongsoft:LightTemplateField>

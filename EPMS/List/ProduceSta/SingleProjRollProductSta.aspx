<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/UI/Master/ObjectList.Master"
    Title="单项目卷册成品统计" CodeBehind="SingleProjRollProductSta.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.ProduceSta.SingleProjRollProductSta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="toolBar" runat="server">
    <span class="filter-block"><span>项目名称 </span><span>
        ...
        <zhongsoft:XHtmlInputText runat="server" ID="txtDesigner" readonly="readonly" class="kpms-textbox"
            style="width: 75px;" />
    </span></span><span class="filter-block"><span>设计规模 </span><span>
...
<asp:Content ID="Content6" ContentPlaceHolderID="advSearch" runat="server">
    ...
    </span></span><span class="filter-block"><span>所属类别</span><span>
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="true"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="WorkDayOfConfirm" HeaderText="定额工日" ItemStyle-HorizontalAlign="Right">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="WBSOwnerName" HeaderText="卷册负责人">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="NewStandardAllSum" HeaderText="新制图" ItemStyle-HorizontalAlign="Right">
            </zhongsoft:LightBoundField>

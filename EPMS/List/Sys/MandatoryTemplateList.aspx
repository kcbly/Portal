...
<asp:Content ID="Content2" ContentPlaceHolderID="toolBar" runat="server">
    ...
    </span></span><span class="filter-block"><span class="filter-block-lb">卷册编号</span> <span>
        <zhongsoft:LightTextBox ID="tbWBSCode" runat="server" CssClass="kpms-textboxsearch"
            EnableTheming="false"></zhongsoft:LightTextBox>
    </span></span><span class="filter-block"><span class="filter-block-lb">规范名称</span> <span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="toolBtn" runat="server">
    <div class="subtoolbarbg">
        <asp:LinkButton runat="server" ID="lbtnImport" OnClientClick="return importMandatory()"
            ...
            <span>
                <img runat="server" id="img2" src="~/Themes/Images/C_write.gif" alt="导入强条" height="16" />导入强条信息</span></asp:LinkButton>
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="True"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="MandatoryContent" HeaderText="强制条文条款及主要内容"

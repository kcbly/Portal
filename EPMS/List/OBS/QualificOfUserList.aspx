...
<asp:Content ID="Content2" ContentPlaceHolderID="toolBar" runat="server">
    ...
    <span><zhongsoft:LightDropDownList runat="server" ID="ddlProjectType" CssClass="kpms-ddlsearch"/></span>
    <span class="filter-block-lb">部门</span> <span><zhongsoft:LightDropDownList runat="server" ID="ddlDept" CssClass="kpms-ddlsearch"/></span>
    <span class="filter-block-lb">专业</span> <span><zhongsoft:LightDropDownList runat="server" ID="ddlSpecialty" CssClass="kpms-ddlsearch"/></span></span>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView runat="server" ID="gvList" AllowPaging="True" Style="word-break: break-all;
        word-wrap: break-word;" PageSize="15" AutoGenerateColumns="false" ShowExport="true"

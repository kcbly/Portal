        ...
        <tr>
            ...
            <td class="td-r">
                <zhongsoft:LightObjectSelector runat="server" ID="txtUserName" IsMutiple="false" SelectPageMode="Dialog"
                    ...
                    ResultAttr="name" ShowAttrs="name,UserCode" ResultForControls="{'hiUserId':'id','tbUserCode':'LoginId','tbDeptName':'DEPTNAME}"
        ...
        <tr>
            <td class="td-m" colspan="6">
                ...
                <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="True"
                    ...
                    OnRowDataBound="gvList_RowDataBound" OnExport="gvList_Export" HideFieldOnExport="全选">
                    <Columns>
                        ...
                        <zhongsoft:LightTemplateField HeaderText="能力系数">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="lblCapacityFactor" runat="server" Visible="false"></asp:Label>
                            </ItemTemplate>
                        </zhongsoft:LightTemplateField>
                                ...
                                <div style="clear: both">
                                    ...
                                    <div style="float: left; width: 19px; padding-left: 0px">
                                        <asp:LinkButton runat="server" ID="btnProjType" Style="height: 18px; width: 20px; padding: 0px"
                                            CssClass="btn-look-up" EnableTheming="false"><img src="../../../Themes/Images/look-up.gif"  style="padding:0px"/>
                                        </asp:LinkButton>
                                    </div>
                                </div>
                            </ItemTemplate>

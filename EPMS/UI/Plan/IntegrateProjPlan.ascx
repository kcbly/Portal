...
<table class="tz-table">
    ...
    <tr style="display: none">
        ...
        <td class="td-r">
            <%--  <zhongsoft:LightDropDownList runat="server" ID="ddlWBSType" req="1" field="ParamWBSTypeID"
                tablename="EPMS_ProjectPlanBook" activestatus="(23.编制项目计划书)(3.会签调整)(3.修改计划)(3.调整计划)(23.编制项目策划、配置人员)">
            </zhongsoft:LightDropDownList>--%>
        ...
        <td class="td-r">
            <%--  <zhongsoft:LightDropDownList runat="server" ID="ddlWBSCode" tablename="EPMS_ProjectPlanBook"
                activestatus="(23.编制项目计划书)(3.会签调整)(3.修改计划)(3.调整计划)(3.调整计划)(23.编制项目策划、配置人员)">
            </zhongsoft:LightDropDownList>--%>

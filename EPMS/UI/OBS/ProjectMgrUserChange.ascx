...
<tr runat="server" id="trRoleConfig" visible="false">
    ...
    <td colspan="5" class="td-m">
        ...
        <asp:CheckBoxList runat="server" ID="cblRoles" RepeatDirection="Horizontal" RepeatColumns="6"
...
<input type="hidden" runat="server" id="hiFilterByRank" value="<root><o roleName='主管总工' rank='副总工程师,总工程师' /><o roleName='勘测副总' rank='副总工程师' /></root>" />
<input type="hidden" runat="server" id="hiFilterByDept" value="<root><o roleName='主管领导' deptCode='200802290000019' /><o roleName='前期项目负责人' deptCode='01017019' /><o roleName='项目助理' deptCode='hostDept' /><o roleName='经营经理' deptCode='hostDept' /></root>" />

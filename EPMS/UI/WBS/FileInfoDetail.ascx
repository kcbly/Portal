...
<tr>
    ...
    <td class="td-m" colspan="3">
        <zhongsoft:LightObjectSelector runat="server" ID="txtProjectName" SourceMode="SelectorPage"
            ...
            ResultForControls="{'hiOrganizationID':'id','txtProjectCode':'ProjectCode','txtPhase':'PhaseName','txtApproveUser':'ManagerUserName'}"
            TableName="EPMS_WBSEntity" Field="ProjectName" activestatus="(2.编写资料交接单)(23.填写专业间互提资料单)(2.收集相关资料)(23.资料登记)"
    ...
    <td class="td-r">
        <zhongsoft:XHtmlInputText runat="server" ID="txtProjectCode" activestatus="(2.编写资料交接单)(23.填写专业间互提资料单)(2.收集相关资料)(23.资料登记)"
...
<tr>
    ...
    <td class="td-r">
        <zhongsoft:XHtmlInputText runat="server" ID="txtPhase" activestatus="(2.编写资料交接单)(23.填写专业间互提资料单)(2.收集相关资料)(23.资料登记)"
    ...
    <td class="td-r" style="display: none">
        <zhongsoft:XHtmlInputText runat="server" ID="txtSpe" readonly="readonly" TableName="EPMS_WBSEntity"
            Field="ExecSpecialtyName" activestatus="(2.编写资料交接单)(23.填写专业间互提资料单)(2.收集相关资料)(23.资料登记)"
        ...
        <asp:ImageButton runat="server" ID="ibtnSelectSpe" ImageUrl="~/Themes/Images/look-up.gif"
            ...
            displaystatus="(2.编写资料交接单)(23.填写专业间互提资料单)(2.收集相关资料)(23.资料登记)" />
    ...
    <td class="td-r">
        <zhongsoft:XHtmlInputText runat="server" ID="txtExternalSupplyDate" activestatus="(23.收集相关资料)"
...
<tr showitem="extendFile">
    ...
    <td class="td-m" colspan="5">
        ...
        <zhongsoft:LightTextBox runat="server" ID="tbProvideFileUnit" TableName="EPMS_FileItemEntity"
            Field="ProvideFileUnit" showitem="extendFile" activestatus="(23.收集相关资料)(23.资料登记)"
...
<tr flag="verify">
    ...
    <td class="td-m" colspan="3">
        <zhongsoft:LightObjectSelector runat="server" ID="txtWBSName" SourceMode="SelectorPage"
            ...
            activestatus="(2.编写资料交接单)(23.填写专业间互提资料单)(2.收集相关资料)(23.资料登记)" BeforeSelect="beforeSelectWbs()"
    ...
    <td class="td-r">
        <zhongsoft:XHtmlInputText runat="server" ID="txtWBSCode" activestatus="(2.编写资料交接单)(23.填写专业间互提资料单)(2.收集相关资料)(23.资料登记)"
            readonly="readonly" class="kpms-textbox" />
    </td>
</tr>
<tr>
    <td class="td-l">资料名称<span class="req-star">*</span>
        ...
        <asp:CheckBox runat="server" ID="cbPlan" Text="计划内" Checked="true" AutoPostBack="true"
            ...
            activestatus="(2.编写资料交接单)(2.填写专业间互提资料单)(2.收集相关资料)" />
    </td>
    <td class="td-m" colspan="3">
        <zhongsoft:LightObjectSelector runat="server" ID="txtFileName" SourceMode="SelectorPage"
            ...
            TableName="EPMS_WBSEntity" Field="WBSName" activestatus="(2.编写资料交接单)(23.填写专业间互提资料单)(2.收集相关资料)(23.资料登记)"
    ...
    <td class="td-r">
        <zhongsoft:XHtmlInputText runat="server" ID="txtFileCode" activestatus="(2.编写资料交接单)(23.填写专业间互提资料单)(2.收集相关资料)(23.资料登记)"
...
<tr>
    ...
    <td class="td-r" hideitem="extendFile">
        <zhongsoft:LightDropDownList runat="server" ID="ddlFileImportance" TableName="EPMS_FileItemEntity"
            Field="FileImportance" activestatus="(23.编写资料交接单)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)">
        </zhongsoft:LightDropDownList>
    </td>
    ...
    <td class="td-r" id="tdWorkItem" style="display: none">
        <zhongsoft:LightTextBox runat="server" ID="tbWorkTerm" TableName="EPMS_WBSEntity"
            Field="WorkTerm" activestatus="(23.编写资料交接单)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)"
            Style="text-align: right;" regex="^([1-9]\d{0,13}|[0])(\.\d{1,2})?$" errmsg="工期请输入最多包含两位小数的数字"></zhongsoft:LightTextBox>
    </td>
    <td class="td-l">
        <asp:Label runat="server" ID="lbAcceptTime" showitem="extendFile">验证日期</asp:Label>
    </td>
    <td class="td-r">
        <zhongsoft:XHtmlInputText runat="server" ID="txtAcceptTime" activestatus="(23.收集相关资料)"
            showitem="extendFile" readonly="readonly" class="kpms-textbox-date" tablename="EPMS_FileItemEntity"
            field="FileConfirmDate" />
    </td>
    <td class="td-l" showitem="extendFile">是否需要总工审批
    </td>
    <td class="td-r" showitem="extendFile">
        <asp:RadioButtonList runat="server" ID="rblIsNeedZGApproval" field="IsNeedZGApproval" tablename="EPMS_WBSEntity"
            reqflag="delegate" RepeatDirection="Horizontal" activestatus="(23.收集相关资料)(3.设总审批)" />
    </td>
    ...
    <td class="td-r" style="display: none;">
        <zhongsoft:LightTextBox runat="server" ID="tbDelay" TableName="WBSEntity" Field="DelayDays"
            activestatus="(23.编写资料交接单)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)" Style="text-align: right;"
            regex="^\d{0,2}$" errmsg="请输入最多2位整数"></zhongsoft:LightTextBox>
    </td>
</tr>
<tr id="trExtendFile">
    <td class="td-l">资料类别<span class="req-star">*</span>
    </td>
    <td class="td-r">
        <zhongsoft:LightDropDownList runat="server" ID="ddlFileType" TableName="EPMS_FileItemEntity"
            reqExtend="true" Field="ParamFileTypeID" activestatus="(23.编写资料交接单)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)"
    ...
    <td class="td-r">
        <zhongsoft:LightDropDownList runat="server" ID="ddlFileForm" TableName="EPMS_FileItemEntity"
            reqExtend="true" Field="FileForm" activestatus="(23.编写资料交接单)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)">
        </zhongsoft:LightDropDownList>
    </td>
    <td class="td-l">资料状态<span class="req-star">*</span>
    </td>
    <td class="td-r">
        <zhongsoft:LightDropDownList runat="server" ID="ddlFileNature" TableName="EPMS_FileItemEntity"
            Field="FileNature" activestatus="(23.资料有效性验证)(23.审批)(3.主设人验证)(3.设总审批)(3.专工验证)(3.总工审批)(23.编写资料交接单)">
        </zhongsoft:LightDropDownList>
    </td>
    ...
    <td class="td-r" style="display: none">
        <%--<zhongsoft:LightDropDownList runat="server" ID="ddlFileSource" TableName="EPMS_FileItemEntity"
            Field="FileSource" activestatus="(23.编写资料交接单)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)"
            req="1">
        </zhongsoft:LightDropDownList>--%>
        <zhongsoft:LightTextBox runat="server" ID="tbFileSource" TableName="EPMS_FileItemEntity"
            Field="FileSource" activestatus="(23.编写资料交接单)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)"></zhongsoft:LightTextBox>
    </td>
</tr>
<tr id="trEquipment" style="display: none">
    ...
    <td class="td-m" colspan="3">
        <zhongsoft:LightObjectSelector runat="server" ID="lboEquipmentName" SourceMode="SelectorPage"
            ...
            TableName="EPMS_FileItemEntity" Field="EquipmentCode" activestatus="(23.收集相关资料)(23.资料登记)"
    ...
    <td class="td-r">
        <zhongsoft:XHtmlInputText runat="server" ID="txtEquipmentCode" activestatus="(23.收集相关资料)(23.资料登记)"
...
<tr>
    ...
    <td class="td-m" colspan="5">
        <zhongsoft:LightTextBox runat="server" ID="tbContent" TableName="EPMS_FileItemEntity"
            Field="FileContent" activestatus="(23.编写资料交接单)(23.校核修改)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)(23.审批修改)(23.批准修改)"
...
<tr runat="server" id="trUpgrade">
    ...
    <td class="td-m" colspan="5">
        <zhongsoft:LightTextBox runat="server" ID="tbUpgradeReason" activestatus="(23.编写资料交接单)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)"
...
<tr flag="verify">
    ...
    <td class="td-r" hideitem="extendFile" flag="verify">
        <zhongsoft:XHtmlInputText runat="server" ID="txtPlanCompleteTime" activestatus="(23.编写资料交接单)(23.填写专业间互提资料单)(23.收集相关资料)(23.资料登记)(23.校核修改)(23.审批修改)(23.批准修改)(23.返回修改或结束)"
...
<tr>
    ...
    <td class="td-l">主设人<span class="req-star">*</span>
    </td>
    <td class="td-r">
        <zhongsoft:LightObjectSelector runat="server" ID="lbsMainDesignerName" IsMutiple="false"
            SelectPageMode="Dialog" activestatus="(23.主设人审核)(23.指派校审人员)(23.填写专业间互提资料单)(23.主设人验证)" SourceMode="SelectorPage"
            ShowJsonRowColName="true" DoCancel="true" ResultAttr="name" ShowAttrs="name,UserCode"
            PageWidth="850" FilterFunction="checkMainDesignerFilter()" ResultForControls="{'hiMainDesignerUserID':'id'}"
            ShowSelectBtn="False" PageUrl="~/EPMS/Obsolete/EPMSUserSelector.aspx" req="1"></zhongsoft:LightObjectSelector>
        <input type="hidden" runat="server" id="hiMainDesignerUserID" />
        <input type="hidden" runat="server" id="hiMainDesignerRoleID" />
    </td>
    <td class="td-l">专工<span class="req-star">*</span>
    </td>
    <td class="td-r">
        <zhongsoft:LightObjectSelector runat="server" ID="lbsPEName" IsMutiple="false"
            SelectPageMode="Dialog" activestatus="(23.专工审核)(23.指派校审人员)(23.填写专业间互提资料单)(23.专工验证)" SourceMode="SelectorPage"
            ShowJsonRowColName="true" DoCancel="true" ResultAttr="name" ShowAttrs="name,UserCode"
...
<tr>
    ...
    <td class="td-r">
        <zhongsoft:LightObjectSelector runat="server" ID="lbsChiefEngineerName" IsMutiple="False" SelectPageMode="Dialog"
            activestatus="(23.设总审批)(23.指派校审人员)(23.填写专业间互提资料单)" SourceMode="SelectorPage"
            ShowJsonRowColName="true" DoCancel="true" ResultAttr="name" ShowAttrs="name,UserCode"
...
<script type="text/javascript">
    ...
    function initFileInfo() {
        ...
        //外部资料
            ...
            //某些步骤必填
            if ($actName == "主设人验证" || $actName == "设总审批" || $actName == "总工审批" || $actName == "设总确认" || $actName == "专工验证"
                || $actName == "总工审批") {
...
//                $('#<%=tbContent.ClientID %>').attr("readonly", "readonly");
    ...
    function wbsFilter() {
        ...
        return { OrganizationID: orgId, WBSType: '<%=(int)WBSMode.卷册管理 %>', ExeSpecialtyID: extSpeId };
    }
    ...
    function checkMainDesignerFilter() {
        var orgId = $('#<%=hiOrganizationID.ClientID %>').val();
        var deptID = $('#<%=hiBelongDeptID.ClientID %>').val();
        var roleID = $('#<%=hiMainDesignerRoleID.ClientID %>').val();
        return "{OrganizationID:'" + orgId + "',RoleID:'" + roleID + "',DeptID:'" + deptID + "',IsQualiticByRole:'1',IsShowMore:'1'}";
    }
    //选择专工
    function checkPEFilter() {
        var orgId = $('#<%=hiOrganizationID.ClientID %>').val();
        var deptID = $('#<%=hiBelongDeptID.ClientID %>').val();
        var roleID = $('#<%=hiPERoleID.ClientID %>').val();
        return "{OrganizationID:'" + orgId + "',RoleID:'" + roleID + "',DeptID:'" + deptID + "',IsQualiticByRole:'1',IsShowMore:'1'}";
    }
    //设总筛选

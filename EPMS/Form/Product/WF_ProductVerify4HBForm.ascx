...
<div>
    <table class="tz-table" width="100%">
        ...
        <tr style="display: none;">
            <td class="td-l">任务类别<span class="req-star">*</span>
            </td>
            <td class="td-m" colspan="5">
        ...
        <tr>
            ...
            <td class="td-m" colspan="3">
                <zhongsoft:LightObjectSelector runat="server" ID="txtProjectName" SourceMode="SelectorPage"
                    ...
                    FilterFunction="projFilter()" ResultForControls="{'hiOrganizationID':'id','txtProjectCode':'ProjectCode'}"
        ...
        <tr>
            <td class="td-l">所属类别<span class="req-star">*</span>
            </td>
            <td class="td-r">
                <zhongsoft:LightDropDownList runat="server" ID="ddlRollType" Width="100px" activestatus="(2.*)(3.建立校审单)" req="1">
                </zhongsoft:LightDropDownList>
            </td>
            <td class="td-l">定额工日
            </td>
            ...
            <td class="td-r">
                <zhongsoft:LightObjectSelector runat="server" ID="txtMasterDesigner" IsMutiple="true"
                    Width="110px" SelectPageMode="Dialog" SourceMode="SelectorPage" ShowJsonRowColName="true"
                    DoCancel="true" ResultAttr="name" ShowAttrs="name,UserCode" PageWidth="850" ResultForControls="{'hiOperatorId':'id'}"
                    PageUrl="~/EPMS/Obsolete/EPMSUserSelector.aspx" activestatus="(23.?)"></zhongsoft:LightObjectSelector>
            </td>
        </tr>
        <tr id="isNeedPassMan">
            <td class="td-l">传阅主设人、专工
            </td>
            <td class="td-m" colspan="5">
                <asp:CheckBox runat="server" ID="cbIsNeedPassMan" activestatus="(3.签署确认)" field="IsNeedPassMan"
                    tablename="EPMS_ProductVerifyForm" />
            </td>
        </tr>
        <tr>
            ...
            <td class="td-l" style="display: none">是否有套用图<span class="req-star">*</span>
            </td>
            <td class="td-r" style="display: none">
                <asp:RadioButtonList runat="server" ID="rblIsHaveReuseMap" RepeatDirection="Horizontal"
                    activestatus="(23.建立校审单)" field="IsHaveReuseMap" tablename="EPMS_ProductVerifyForm">
            ...
            <td class="td-r">
                <zhongsoft:LightObjectSelector runat="server" ID="txtChecker" IsMutiple="false" Width="110px" req="1"
                    ...
                    ResultAttr="name" ShowAttrs="name,UserCode" PageWidth="850" ResultForControls="{'hiCheckerId':'id'}"
                    FilterFunction="getCheckFilter()" PageUrl="~/EPMS/Obsolete/EPMSUserSelector.aspx" activestatus="(3.分配校审任务)(3.确定成品校核人)"
                    OnClick="txtChecker_Click"></zhongsoft:LightObjectSelector>
                <input type="hidden" runat="server" id="hiCheckerId" />
            </td>
        </tr>
        <!-- 技经投资额-->
        <tr id="trInvestment">
            <td class="td-l">静态投资额<span class="req-star">*</span>
            </td>
            <td class="td-r">
                <zhongsoft:LightTextBox runat="server" ID="tbStaticInvestment" activestatus="(23.建立校审单)(23.分配校审任务)(23.设计修改)"
                    DataType="Money6" Style="width: 80px; text-align: right;" />万元
                <input type="hidden" runat="server" id="hiStaticInvestment" field="StaticInvestment"
                    tablename="EPMS_ProductVerifyForm" />
            </td>
            <td class="td-l">动态投资额<span class="req-star">*</span>
            </td>
            <td class="td-r">
                <zhongsoft:LightTextBox runat="server" ID="tbDynamicInvestment" activestatus="(23.建立校审单)(23.分配校审任务)(23.设计修改)"
                    DataType="Money6" Style="width: 80px; text-align: right;" />万元
                <input type="hidden" runat="server" id="hiDynamicInvestment" field="DynamicInvestment"
                    tablename="EPMS_ProductVerifyForm" />
            </td>
            <td class="td-m" colspan="2"></td>
        </tr>
        <tr id="trYlgd">
            <td class="td-l">压力管道级别<span class="req-star">*</span>
            </td>
            <td class="td-r">
                <zhongsoft:LightDropDownList runat="server" ID="ddlPressurePipeLevel" field="PressurePipeLevelID"
                    tablename="EPMS_ProductVerifyForm" activestatus="(23.建立校审单)(23.分配校审任务)">
                </zhongsoft:LightDropDownList>
            </td>
            <td class="td-l">压力管道审核人
            </td>
            <td class="td-r">
                <zhongsoft:LightObjectSelector runat="server" ID="txtYLSHer" IsMutiple="false" Width="110px"
                    SelectPageMode="Dialog" SourceMode="SelectorPage" ShowJsonRowColName="true" DoCancel="true"
                    ResultAttr="name" ShowAttrs="name,UserCode" PageWidth="850" ResultForControls="{'hiYSSHId':'id'}"
                    PageUrl="~/EPMS/Obsolete/EPMSUserSelector.aspx" activestatus="(23.建立校审单)(23.分配校审任务)"
                    OnClick="txtYLSHer_Click" FilterFunction="getYLSHFilter()"></zhongsoft:LightObjectSelector>
                <input type="hidden" runat="server" id="hiYSSHId" />
            </td>
            <td class="td-l">压力管道审定人
            </td>
            <td class="td-r">
                <zhongsoft:LightObjectSelector runat="server" ID="txtYLSDer" IsMutiple="false" Width="110px"
                    SelectPageMode="Dialog" SourceMode="SelectorPage" ShowJsonRowColName="true" DoCancel="true"
                    ResultAttr="name" ShowAttrs="name,UserCode" PageWidth="850" ResultForControls="{'hiYLSDId':'id'}"
                    PageUrl="~/EPMS/Obsolete/EPMSUserSelector.aspx" activestatus="(23.建立校审单)(23.分配校审任务)"
                    OnClick="txtYLSDer_Click" FilterFunction="getYLSDFilter()"></zhongsoft:LightObjectSelector>
                <input type="hidden" runat="server" id="hiYLSDId" />
            </td>
        </tr>
        <tr id="trShowInVerify">
            <td class="td-l">是否需总工签署
            </td>
            <td class="td-m" colspan="5">
                <!-- 增加table，避免红字换行影响美观-->
                <table>
                    <tr>
                        ...
                        <td>
                            <span style="color: Red">注意：如果卷册不出版但需要总工签署，卷册负责人需要手动选择！</span>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr runat="server" id="trOuter" visible="false">
            <td class="td-l">是否发起出版流程<span class="req-star" id="reqPublish" runat="server" visible="false">*</span>
            </td>
            <td class="td-m" colspan="5">
        ...
        <tr runat="server" id="trSurveryVerify" visible="false">
            ...
            <td class="td-r">
                <zhongsoft:LightObjectSelector runat="server" ID="lbsSelMutual" SourceMode="SelectorPage"
                    ...
                    BeforeSelect="beforeSelectFile()" FilterFunction="filterMutualFilter()" AfterSelect="afterFileSelect()"
        ...
        <tr runat="server" id="trSendUp" visible="false">
            <td class="td-l">是否运转至最高级<span class="req-star">*</span>
            </td>
            <td class="td-m" colspan="3">
                <asp:RadioButtonList runat="server" ID="rblIsSendUp" activestatus="(23.建立校审单)" Field="IsSendUp"
                    TableName="EPMS_ProductVerifyForm" req="1" RepeatDirection="Horizontal">
                    <asp:ListItem Value="1">是</asp:ListItem>
                    <asp:ListItem Value="0">否</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        ...
        <tr id="trProductChange">
            <td class="td-l">成品是否有变化
            </td>
            <td class="td-m" colspan="5">
                <asp:CheckBox runat="server" ID="cbIsProductChange" activestatus="(3.校核1)(3.校核)(3.主设人校审)(3.压力管道审核)(3.主任工校审)(3.压力管道审定)(3.专工校审)(3.勘测专工校审)(3.分项设总校审)(3.设总校审)(3.总工校审)(3.专业总工批准)(3.院长批准)" />
                <input type="hidden" runat="server" id="hiIsProductChange" field="IsProductChange"
                    tablename="EPMS_ProductVerifyForm" />
                <span style="color: Red">注意：只有校审步骤可操作，如果成品数量或校审类别有变化，在校审修改步骤卷册负责人可以上传新的成品。</span><br />
            </td>
        </tr>
        <tr id="notShowInFinishVerify">
            <td class="td-l">
                <a class="aStyle" onclick="showWBSDetail()">卷册档案袋</a>
                <%--<asp:LinkButton ID="lkbFiles" runat="server" OnClientClick="return openFileDetail()"
                    class="aStyle" EnableTheming="false" ForeColor="Blue">
                接口资料
                </asp:LinkButton>--%>
            </td>
            <td class="td-r" dflag="2">
                <uc1:WBSConditonStats ID="wbsCondition" runat="server" />
            </td>
            <td class="td-m" colspan="3" dflag="1"></td>
            <td colspan="2" class="td-m" dflag="0">
                <span class="req-star">是否具备校审条件：
                    <asp:Label runat="server" ID="lbIsHaveCondition"></asp:Label>
                </span>
                <br />
                <a runat="server" id="aAllowGoFlowMemo" class="aStyle" href="~/Sys/Download/EPMS/特殊放行管理说明文件.pdf"
                    target="_blank" visible="false">特殊放行管理说明文件
                    <br />
                </a><a runat="server" id="aStartAllowGoFlow" class="aStyle" onclick="startAllowGoFlow()"
                    visible="false" target="_blank">发起特殊放行管理流程</a> <a runat="server" id="aViewAllowGoFlow"
                        visible="false" title="点击查看特殊放行管理流程" class="aStyle">点击查看特殊放行管理流程</a>
                <input type="hidden" runat="server" id="hiIsHaveCondition" field="IsHaveCondition"
                    tablename="EPMS_ProductVerifyForm" />
                <br />
                <span style="color: Red; display: none;">说明：如果不具备，必须经过主任工、设总或者部长允许</span>
            </td>
            <td colspan="4" class="td-m" dflag="2">
                <table width="100%">
                    <tr>
                        <td>
                            <a target="_blank" class="aStyle" href="<%=WebAppPath %>/EPMS/Download/306设计产品验证及质量评定规定.doc">306设计产品验证及质量评定规定</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <a target="_blank" class="aStyle" href="<%=WebAppPath %>/EPMS/Download/307设计产品会签规定.doc">307设计产品会签规定</a>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <!--校审条件-->
        <tr id="noShowInFinishVerify" dflag="0">
            <td class="td-l">校审条件
            </td>
            <td colspan="5" class="td-m">
                <span class="req-star" id="spSJJS">简单工程：卷册存在未提交、未接受的资料项，《简单项目策划》流程未经主管总工审批，为不具备条件。如需校审，请发起《特殊放行管理》流程。<br />
                    非简单工程：卷册存在未提交、未接受的资料项，《项目综合计划书》或《简单项目策划》流程未经审批，“开工会”或“出工会”的《工程会议纪要》未经审批，为不具备条件。如需校审，请发起《特殊放行管理》流程。
                </span><span class="req-star" id="spKCJS">简单工程：卷册存在未提交（非互提资料项）、未接受的资料项，《简单项目策划》流程未经主管总工审批，未不具备条件。如需校审，请发起《特殊放行管理》流程。<br />
                    非简单工程：卷册存在未提交、未接受的资料项，《项目综合计划书》或《简单项目策划》流程未经审批，“开工会”或“出工会”的《工程会议纪要》未经审批，为不具备条件。如需校审，请发起《特殊放行管理》流程。
                </span><span class="req-star" id="spZHJS">简单工程：《简单项目策划》未经批准，初可、可研、初设的《综合评审》未经批准，为不具备条件。如需校审，请发起《特殊放行管理》流程。<br />
                    非简单工程：《项目综合计划书》或《简单项目策划》流程未经审批，“开工会”的《工程会议纪要》未经审批，为不具备条件。如需校审，请发起《特殊放行管理》流程。
                </span>
            </td>
        </tr>
        ...
        <!-- 只在编辑状态显示-->
        <tr runat="server" displaystatus="(3.?)(3.?)">
            <td class="td-l">
                <a class="aStyle" onclick="startProductmodify()" target="_blank">发起成品设计修改</a>
            </td>
            <td class="td-m" colspan="5">
...
<table class="tz-table" width="100%" id="tbVerifyPoint">
...
<table class="tz-table" width="100%" id="tbMandatory">
    <tr id="trIsWBSMandatory" style="display: none">
        <td class="td-l">该卷册满足工程建设强制性标准要求
        </td>
        <td class="td-m" colspan="5">
            <asp:CheckBox runat="server" ID="cbIsWBSMandatory" activestatus="(3.校核1)(3.校核)(3.主设人校审)(3.压力管道审核)(3.主任工校审)(3.压力管道审定)(3.专工校审)(3.勘测专工校审)(3.分项设总校审)(3.设总校审)(3.总工校审)(3.专业总工批准)(3.院长批准)" />
            <input type="hidden" runat="server" id="hiIsWBSMandatory" field="IsWBSMandatory"
                tablename="EPMS_ProductVerifyForm" />
            <span style="color: Red">注意：只有校审步骤可操作，如果没有勾选此选项，只能回退给卷册负责人进行成品修改</span><br />
        </td>
    </tr>
    <tr id="mandatoryHeader" style="display: none">
...
<table class="tz-table" width="100%" id="tbEvaluation">
    <tr>
        <td colspan="6" class="flexible" onclick="openDetail('qualityEvaluation')">质量评语&nbsp;<img src="<%=WebAppPath%>/themes/images/lright.png" />
        </td>
    </tr>
...
<input type="hidden" runat="server" id="hiPublishFlag" value="出版" />
<!---海外事业部部门编号---->
...
<script type="text/javascript">
    ...
    function initWBSFlag() {
        $("#<%=cblWBSFlag.ClientID %>").live("change", function () {
            //if(checkValueChecked("出版")){
            checkIsNeedSGSign();
            //}
            //if(checkValueChecked("压力管道")){
            initYlgd();
            //}
        });
...
//                $("#<%=cblWBSFlag.ClientID %>").live("change", function () {  checkedRefreshProductList(); })
    ...
    function initInvestment() {
        ...
        if (verifyType == "<%=(int)ProductVerifyType.设计成品校审 %>" && speCode.toLowerCase() == 'e') {
            $('#trInvestment').show();
            $('#<%=tbStaticInvestment.ClientID %>').attr('req', '1');
            $('#<%=tbDynamicInvestment.ClientID %>').attr('req', '1');
        }
    }
    ...
    function wbsFilter() {
        ...
        return { OrganizationID: orgId, WBSType: '<%=WBSMode.卷册管理.GetHashCode() %>', WBSFormTypeSelect: formType, OwnerId: ownerId, IsShowMore: 1 };
    }
    ...
    function selectRelaWBS() {
        ...
        var json = { OrganizationID: orgId, WBSType: '<%=(int)WBSMode.卷册管理 %>', WBSState:'<%=WBSState.已完成.GetHashCode() %>' };
    ...
    function checkForm() {//原有方法: KPMSCheckSubmit
        ...
        if ($formAction == 0 || $formAction == 1) {//原有属性: $readyFormSend
            ...
            <%--if ($actName == '签署确认' || $actName == "自动批签及PLT确认") {
                var hiHasNotify = $('#<%=hiHasNotify.ClientID %>').val();
                if (hiHasNotify != '') {
                    alert('当前项目的【成品发送单流程】尚未结束，请先结束！');
                    return false;
                }
            }--%>
        ...
        if (($actName.indexOf("校核") > -1 || $actName.indexOf("校审") > -1 || $actName.indexOf("审核") > -1
            ...
            if (result != "" && result != null && result != undefined) {
                if ($formAction == 0) {//发送的时候
                    if ($('#<%=cbIsProductChange.ClientID %>').is(':checked') || parseBool(result)) {
                        alert('您填写了校审意见或勾选了成品数量有变化，请点击需修改按钮回退到设计修改步骤进行修改！');
                        return false;
                    }
                }
                else if ($formAction == 1) {
                    if (!parseBool(result) && !$('#<%=cbIsProductChange.ClientID %>').is(':checked')) {//回退的时候
        ...
        if ($formAction == 0 && $actName == '建立校审单') {
            var haveResueMap = $('#<%=rblIsHaveReuseMap.ClientID %> input:checked').val();
            if (haveResueMap == '1') {
                var reuseCnt = $('#<%=hiReuseCnt.ClientID %>').val();
                if (reuseCnt == '0') {
                    alert('您选择了该卷册有套用图但是没有添加，请先添加套用图再发送流程！');
                    return false;
                }
            }
        }
        ...
        if (($actName.indexOf("校核") > -1 || $actName.indexOf("校审") > -1 || $actName.indexOf("审核") > -1
            ...
            && $actName != '建立校审单' && $actName != '分配校审任务') {//验证排除建立校审单步骤
            var result;
            if (!$('#<%=cbIsWBSMandatory.ClientID %>').is(':checked') && $formAction == 0) {//发送
                alert('您未勾选【该卷册满足工程建设强制性标准要求】，说明此卷册目前不符合强条要求，请点击回退按钮回退到设计修改步骤进行修改！');
                $('#<%=cbIsWBSMandatory.ClientID %>').focus();
                return false;
            }
        }
        return true;
    ...
    function initYlgd() {
        if (checkValueChecked('压力管道')) {
            $('#trYlgd').show();
            $('#<%=ddlPressurePipeLevel.ClientID %>').attr('req', '1');
        }
        else {
            $('#trYlgd').hide();
            $('#<%=ddlPressurePipeLevel.ClientID %>').removeAttr('req');
        }
    }
    ...
    function checkIsNeedSGSign() {
        ...
        var isPublish = checkValueChecked("出版");
        //不需要出版，是否需要总工签署可以编辑
        if (!isPublish) {
            //$("#<%=rbIsNeedZgzgSign.ClientID %>").removeAttr("disabled");
            $("#<%=rbIsNeedZgzgSign.ClientID %> :radio").each(function () {
    ...
    function getYLSHFilter() {
        var ylType = $('#<%=ddlPressurePipeLevel.ClientID %> option:selected').text();
        var projectTypeId ='<%=ProjectInfo.ParamProjectTypeID %>';
        return { 'ProjectTypeID': projectTypeId, 'IsFilterByProjectTypeID': '1', "QualificationName": ylType + '审核' }
    }

    function getYLSDFilter() {
        var ylType = $('#<%=ddlPressurePipeLevel.ClientID %> option:selected').text();
        var projectTypeId ='<%=ProjectInfo.ParamProjectTypeID %>';
        return { 'ProjectTypeID': projectTypeId, 'IsFilterByProjectTypeID': '1', "QualificationName": ylType + '审定' }
    }

    //设总筛选
    function getCheckFilter() {
        var qjrRoleID = '<%=QJRRollID%>';
        var deptID = '<%=KPMSUser.DeptId%>';
        var orgID = $('#<%=hiOrganizationID.ClientID %>').val();
        var specID = $('#<%=hiBelongSpecialtyID.ClientID %>').val();
        return "{RoleID:'" + qjrRoleID + "',OrganizationID:'" + orgID + "',SpecialtyID:'" + specID + "',IsShowMore:'1',IsQualiticByRole:'1',DeptID: '" + deptID + "',QualificationName:'设计全校人',IsFilterByProjectTypeID:'1',ProjectTypeID:'37'}"
    }
</script>

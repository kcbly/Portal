<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_RiskManagementForm.ascx.cs" Inherits="Zhongsoft.Portal.EPMS.Form.Risk.WF_RiskManagementForm" %>
<table class="tz-table">
    ...
    <tr>
        <td class="td-l">分析评估人员<span class="req-star">*</span></td>
        <td class="td-r">
            <zhongsoft:LightObjectSelector ID="tbAssessUserName" runat="server" ActiveStatus="(23.编制)"
                TableName="EPMS_RiskManagement" Field="AssessUserName" class="kpms-textbox" req="1"
                IsMutiple="false" SourceMode="SelectorPage" ShowJsonRowColName="true" ResultAttr="name"
                PageUrl="~/Sys/OrgUsers/UserSelectorJson.aspx" ResultForControls="{'hiAssessorUserID':'id'}"
                SelectPageMode="Dialog" />
            <input type="hidden" runat="server" id="hiAssessorUserID" field="AssessorUserID" tablename="EPMS_RiskManagement" />
        </td> 
            <td class="td-l">项目负责人</td>
            <td class="td-r">
                <zhongsoft:XHtmlInputText class="kpms-textbox" ID="tbManagerUserName" runat="server" readonly="readonly"
                    ActiveStatus="(23.编制)" field="ManagerUserName" tablename="EPMS_RiskManagement" />
                <input type="hidden" id="hiManagerUserID" name="hiManagerUserID" runat="server" tablename="EPMS_RiskManagement" field="ManagerUserID" />
            </td>
        </tr>
    <tr>
        ...
        <td colspan="6">
            <zhongsoft:LightPowerGridView runat="server" ID="gvList" AutoGenerateColumns="false" PermissionStatus="true"
                ...
                <Columns>
                    ...
                    <zhongsoft:LightTemplateField HeaderText="风险点<span class='req-star'>*</span>" ItemStyle-Width="100px">
                        <ItemTemplate>
                            <zhongsoft:LightTextBox runat="server" ID="tbRiskName" Text='<%# Eval("RiskName") %>' req="1"
                                CssClass="kpms-textarea" EnableTheming="false" TextMode="MultiLine"
                                ActiveStatus="(23.编制)"></zhongsoft:LightTextBox>
                        </ItemTemplate>
                    </zhongsoft:LightTemplateField>
                    <zhongsoft:LightTemplateField HeaderText="风险描述" ItemStyle-Width="110px">
                        <ItemTemplate>
                            <zhongsoft:LightTextBox runat="server" ID="tbRiskDescribe" Text='<%# Eval("RiskDescribe") %>'
                                CssClass="kpms-textarea" TextMode="MultiLine" EnableTheming="false"
                                ActiveStatus="(23.编制)"></zhongsoft:LightTextBox>
                        </ItemTemplate>
                    </zhongsoft:LightTemplateField>
                    <zhongsoft:LightTemplateField HeaderText="风险级别<span class='req-star'>*</span>" ItemStyle-Width="75px">
                        <ItemTemplate>
                            <zhongsoft:LightDropDownList runat="server" ID="ddlRiskRank" req="1" ActiveStatus="(23.编制)">
                              ...
                              <asp:ListItem Value="微不足道">微不足道</asp:ListItem>
                                <asp:ListItem Value="可接受">可接受</asp:ListItem>
                    ...
                    <zhongsoft:LightTemplateField HeaderText="控制措施<span class='req-star'>*</span>" ItemStyle-Width="110px">
                        <ItemTemplate>
                    ...
                    <zhongsoft:LightTemplateField HeaderText="措施效果<span class='req-star'>*</span>" ItemStyle-Width="110px">
                        <ItemTemplate>
                            <zhongsoft:LightTextBox ID="tbMeasureResult" CssClass="kpms-textarea" runat="server"
                                Text='<%# Eval("MeasureResult") %>' req="1" ActiveStatus="(23.编制)"
                                TextMode="MultiLine" EnableTheming="false"></zhongsoft:LightTextBox>
                        </ItemTemplate>
                    </zhongsoft:LightTemplateField>
                    <zhongsoft:LightTemplateField HeaderText="结束时间<span class='req-star'>*</span>" ItemStyle-Width="60px">
                        <ItemTemplate>
                    ...
                    <zhongsoft:LightTemplateField HeaderText="检查人" ItemStyle-Width="80px">
                        <ItemTemplate>
                            <zhongsoft:LightObjectSelector ID="tbCheckUserName" runat="server" ActiveStatus="(23.编制)"
                                class="kpms-textbox" IsMutiple="false" SourceMode="SelectorPage" ShowJsonRowColName="true" ResultAttr="name"
                                PageUrl="~/Sys/OrgUsers/UserSelectorJson.aspx" ResultForControls="{'hiCheckUserID':'id'}"
                                SelectPageMode="Dialog" Value='<%# Eval("CheckUserName") %>' />
                            <input type="hidden" runat="server" id="hiCheckUserID" value='<%# Eval("CheckUserID") %>' />
                            <asp:Label ID="lblCheckUserName" runat="server" Visible="false" ><%#Eval("CheckUserName") %></asp:Label>
                        </ItemTemplate>
                    </zhongsoft:LightTemplateField>

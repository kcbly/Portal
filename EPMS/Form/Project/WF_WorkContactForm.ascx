...
<table class="tz-table" width="100%">
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList runat="server" ID="ddlPutSpecialty" tablename="EPMS_WorkContactForm"
                field="PutSpecialtyID" activestatus="(23.填写工作联系单)(23.重新填写工作联系单)(23.编写问题请决单)(23.编制预案)"

...
<table class="tz-table" width="100%">
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox" ID="txtApplyUserName" runat="server" readonly="readonly"
                ActiveStatus="(2.填写设计变更通知单)" field="ApplyUserName" tablename="EPMS_DesignChangeNotice" />
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox" ID="txtApplyDeptName" runat="server" readonly="readonly"
                ActiveStatus="(2.填写设计变更通知单)" field="ApplyDeptName" tablename="EPMS_DesignChangeNotice" />
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox-date" ID="txtApplyDate" runat="server" readonly="readonly"
                ActiveStatus="(2.填写设计变更通知单)" field="ApplyDate" tablename="EPMS_DesignChangeNotice" />
        </td>
    </tr>
    <tr>
        ...
        <td class="td-m" colspan="3">
            <zhongsoft:LightObjectSelector runat="server" ID="tbProjectName" IsMutiple="false" req="1"
                ...
                ResultAttr="name" ActiveStatus="(23.填写设计变更通知单)" field="ProjectName" tablename="EPMS_DesignChangeNotice" />
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox" ID="tbProjectCode" runat="server" readonly="readonly"
                ActiveStatus="(23.填写设计变更通知单)" field="ProjectCode" tablename="EPMS_DesignChangeNotice" />
        </td>
    </tr>
    <tr>
        <td class="td-l">涉及图名<span class="req-star">*</span></td>
        <td class="td-r">
            <zhongsoft:LightTextBox class="kpms-textbox" ID="txtDrawingNo" runat="server" req="1"
                ActiveStatus="(23.填写设计变更通知单)" field="DrawingNo" tablename="EPMS_DesignChangeNotice" />
        </td>
        <td class="td-l">主送单位<span class="req-star">*</span></td>
        <td class="td-m" colspan="3">
            <zhongsoft:LightObjectSelector runat="server" ID="tbHostDept" IsMutiple="true" req="1"
                ...
                ResultAttr="name" field="HostDeptName" tablename="EPMS_DesignChangeNotice" ActiveStatus="(23.填写设计变更通知单)" />
            <input type="hidden" id="hiHostDeptID" runat="server" field="HostDeptID" tablename="EPMS_DesignChangeNotice" />
        </td>
    </tr>
    <tr>
        <td class="td-l">涉及图号<span class="req-star">*</span></td>
        <td class="td-r">
            <zhongsoft:LightTextBox class="kpms-textbox" ID="txtDrawingName" runat="server"
                ActiveStatus="(23.填写设计变更通知单)" field="DrawingName" tablename="EPMS_DesignChangeNotice" />
        </td>
        <td class="td-l">抄送单位</td>
        <td class="td-m" colspan="3">
            <zhongsoft:LightObjectSelector runat="server" ID="tbCopyDept" IsMutiple="true" req="1"
                SelectPageMode="Dialog" ResultForControls="{'hiCopyDeptID':'id'}" EnableTheming="false"
                Text="选择抄送单位" PageUrl="~/Sys/OrgUsers/OrgSelectorJson.aspx" ShowJsonRowColName="true"
                ResultAttr="name" field="CopyDeptName" tablename="EPMS_DesignChangeNotice" ActiveStatus="(23.填写设计变更通知单)" />
    ...
    <tr>
        ...
        <td class="td-m" colspan="3">
            <asp:RadioButtonList runat="server" ID="rblChangeType" RepeatDirection="Horizontal" req="1" RepeatColumns="3"
                field="ChangeType" tablename="EPMS_DesignChangeNotice" ActiveStatus="(23.填写设计变更通知单)">
            </asp:RadioButtonList>
        </td>
        <td class="td-l">变更编号</td>
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox" ID="txtChangeCode" runat="server"
                field="ChangeCode" tablename="EPMS_DesignChangeNotice" ActiveStatus="(23.填写设计变更通知单)" />
        </td>
    </tr>
    <tr>
        <td class="td-l">变更原因<span class="req-star">*</span></td>
        <td class="td-m" colspan="5">
            <asp:CheckBoxList ID="cblChangeReason" runat="server" RepeatColumns="1" req="1" RepeatDirection="Horizontal" ActiveStatus="(23.填写设计变更通知单)"></asp:CheckBoxList>
    ...
    <tr>
        ...
        <td class="td-r">
            <asp:RadioButtonList runat="server" ID="rbIsNowSign" RepeatDirection="Horizontal" req="1"
                field="IsNowSign" tablename="EPMS_DesignChangeNotice" ActiveStatus="(23.填写设计变更通知单)">
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox" ID="txtFileCode" runat="server"
                field="FileCode" tablename="EPMS_DesignChangeNotice" ActiveStatus="(23.填写设计变更通知单)" />
        </td>
        <td class="td-l">附：文件扫描/复印件</td>
        <td class="td-r">
            <asp:CheckBox ID="cbIsAttachment" runat="server" field="IsAttachment" tablename="EPMS_DesignChangeNotice" ActiveStatus="(23.填写设计变更通知单)" />
        </td>
    </tr>
    <tr>
        <td class="td-l">附件</td>
        <td class="td-r" colspan="5">
            <zhongsoft:LightFileUploader ID="upLoadFile" runat="server" ActiveStatus="(23.填写设计变更通知单)" OnClick="upLoadFile_Click">
                <span>

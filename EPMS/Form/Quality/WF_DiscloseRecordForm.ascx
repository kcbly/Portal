...
<table class="tz-table" width="100%">
    ...
    <tr>
        ...
        <td class="td-l">地点</td>
        <td class="td-m" colspan="3">
            <zhongsoft:LightTextBox ID="tbRecordPlace" runat="server" MaxLength="1024" req="1" CssClass="kpms-textarea" TextMode="MultiLine"
    ...
    <tr>
        <td class="td-l">主要内容<br />
            （重要环安因素<br />及控制措施、<br />
            其他安全环保<br />注意事项等）<span class="req-star">*</span></td>
        <td class="td-m" colspan="5">

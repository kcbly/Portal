...
<table class="tz-table" width="100%">
    <tr>
        ...
        <td class="td-m" colspan="3">
            <zhongsoft:LightObjectSelector runat="server" ID="tbProjectName" IsMutiple="false" req="1"
                ...
                ResultAttr="name" TableName="EPMS_QualityActivityOfProject" Field="ProjectName" ActiveStatus="(23.编制设计评审记录)" Height="28px" />
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox" ID="tbProjectCode" runat="server" readonly="readonly" TableName="EPMS_QualityActivityOfProject" Field="ProjectCode" ActiveStatus="(23.编制设计评审记录)" />
        </td>
    </tr>
    <tr>
        <td class="td-l">设计阶段<span class="req-star">*</span></td>
        <td class="td-m" colspan="5">
            <asp:CheckBoxList runat="server" ID="cblProjectPhases" activestatus="(23.编制设计评审记录)" RepeatDirection="Horizontal" req="1" />
    </tr>
    <tr>
        <td class="td-l">评审编号
        </td>
        <td class="td-r">
            <zhongsoft:XHtmlInputText runat="server" ID="txtSerialNumber" activestatus="(23.编制设计评审记录)"
        ...
        <td class="td-r">
            <asp:RadioButtonList ID="rblReViewLevel" req="1" runat="server" tablename="EPMS_QualityActivityOfProject" field="ReViewLevel" activestatus="(23.编制设计评审记录)" RepeatDirection="Horizontal"></asp:RadioButtonList>
        </td>
        <td class="td-l">评审时间<span class="req-star">*</span>
        </td>
        <td class="td-r">
            <zhongsoft:XHtmlInputText runat="server" ID="txtViewTime" activestatus="(23.编制设计评审记录)"
    ...
    <tr>
        ...
        <td class="td-r" colspan="5">
            <zhongsoft:LightTextBox ID="tbActivityContent" runat="server" MaxText="5000" TextMode="MultiLine"
                CssClass="kpms-textarea" EnableTheming="false" ActiveStatus="(23.编制设计评审记录)"
    ...
    <tr>
        ...
        <td class="td-r">
            <asp:RadioButtonList ID="rblReViewMethod" req="1" runat="server" tablename="EPMS_QualityActivityOfProject" field="ReViewMethod" activestatus="(23.编制设计评审记录)" RepeatDirection="Horizontal"></asp:RadioButtonList>
        </td>
        <td class="td-l">评审组长<span class="req-star">*</span>
        </td>
        <td class="td-r">
            <zhongsoft:LightObjectSelector runat="server" ID="txtInnerEmceeUserName" IsMutiple="false"
                SelectPageMode="Dialog" activestatus="(23.编制设计评审记录)" SourceMode="SelectorPage" ShowJsonRowColName="true" DoCancel="true" ResultAttr="name" BeforeSelect="beforeSelectUser()" PageWidth="800px" req="1"
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText runat="server" ID="txtStartUserName" activestatus="(23.编制设计评审记录)"
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightObjectSelector ID="lbsInnerParticipantName" runat="server" ActiveStatus="(23.编制设计评审记录)"
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightFileUploader runat="server" ID="lbtnUpload" EnableTheming="false"
                DisplayStatus="(23.编制设计评审记录)" OnClick="upLoadFile_Click">
...
<script type="text/javascript"> 
    ...
    function checkForm() {//原有方法: KPMSCheckSubmit 
        if ($formAction == 2) {//原有属性: $readyFormSend
            if ($actName == "编制设计评审记录") {//$actName 系统变量 

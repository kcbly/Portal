...
<table class="tz-table" width="100%">
    ...
    <tr>
        ...
        <td class="td-l">
            是否数字化设计<span class="req-star">*</span>
        </td>
        <td class="td-r">
            <asp:RadioButtonList ID="rdblIsDigitalDesign" runat="server" ActiveStatus="(23.接收任命书并打印)"
                Field="IsDigitalDesign" TableName="EPMS_ProjectResource" RepeatColumns="2" req="1">
                <asp:ListItem Text="是" Value="1"></asp:ListItem>
                <asp:ListItem Text="否" Value="0"></asp:ListItem>
            </asp:RadioButtonList>
        </td>
        <td class="td-l">
            是否创优<span class="req-star">*</span>
        </td>
        <td class="td-r">
            <asp:RadioButtonList ID="rdblIsExcellent" runat="server" ActiveStatus="(23.接收任命书并打印)"
                Field="IsExcellent" TableName="EPMS_ProjectResource" RepeatColumns="2" req="1">
                <asp:ListItem Text="是" Value="1"></asp:ListItem>
                <asp:ListItem Text="否" Value="0"></asp:ListItem>
            </asp:RadioButtonList>
        </td>
    ...
    function checkForm() {
        if ($formAction == 0) {
            if ($actName == "接收任命书并打印") {
                ...
                var value1 = $("#<%=rdblIsSimpleProject.ClientID %> input[type='radio']:checked").val();
                //var value2 = $("#//<//%=//rdblCheckSimpleProject.//ClientID %//> input[type='radio']:checked").val();
                //|| (value1 == "1" && value2 == "1")
                //if (value1 == "0" ) {

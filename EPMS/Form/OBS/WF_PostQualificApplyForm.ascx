            ...
            <zhongsoft:LightPowerGridView runat="server" ID="gvList" AutoGenerateColumns="false" PermissionStatus="true"
                ...
                <Columns>
                    ...
                    <zhongsoft:LightTemplateField HeaderText="资质名称<span class='req-star'>*</span>">
                        <ItemTemplate>
                            <zhongsoft:LightDropDownList ID="ddlQualification" runat="server" ActiveStatus="(23.资格申报)"  req="1"></zhongsoft:LightDropDownList>
                        ...
                        <ItemTemplate>
                            <div style="clear: both">
                                <div style="float: left; width: 80%">
                                    <zhongsoft:LightTextBox runat="server" ID="tbProjType" Height="50px"  Width="100%"

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_ProjMemberChangeForm.ascx.cs"
    Inherits="Zhongsoft.Portal.EPMS.Form.OBS.WF_ProjMemberChangeForm" %>
...
<table class="tz-table" width="100%">
    ...
    <uc3:ProjectMgrUserChange ID="mgrUser" runat="server" Visible="false" />
    <uc5:ProjectSpeUserChange ID="speUser" runat="server" Visible="false" />
    <tr>
...
<input type="hidden" id="hiCheckFlowMes" name="hiCheckFlowMes" runat="server" value="《项目组成员配置》或《简单项目策划》流程还未发起,不能进行变更！" />
...
<input type="hidden" id="hiCheckFlowMes2" name="hiCheckFlowMes2" runat="server" value="该项目正在走《项目组成员配置》或《简单项目策划》流程，为了避免人员更新错误，请先将正在运转的《项目组成员配置》或《简单项目策划》流程结束然后再走《项目组成员变更》流程！" />

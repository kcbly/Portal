...
<table class="tz-table">
    <tr>
        ...
        <td class="td-m" colspan="3">
            <zhongsoft:LightObjectSelector runat="server" ID="tbProjectName" IsMutiple="false" req="1"
                ...
                ShowJsonRowColName="true" ResultAttr="name" TableName="EPMS_SurveyBrief" Field="ProjectName" ActiveStatus="(23.编制大纲)(23.编制)(23.修改)" />
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox" ID="tbProjectCode" runat="server" readonly="readonly" TableName="EPMS_SurveyBrief" Field="ProjectCode" ActiveStatus="(23.编制大纲)(23.编制)(23.修改)" />
        </td>
    </tr>
    <tr runat="server" id="trSpecialty">
        <td class="td-l">专业</td>
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlSpecialty" runat="server" TableName="EPMS_SurveyBrief" Field="SpecialtyID" ActiveStatus="(23.编制大纲)" />
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox" ID="txtWriteUserName" runat="server" readonly="readonly" TableName="EPMS_SurveyBrief" Field="WriteUserName" ActiveStatus="(2.编制大纲)(2.编制)(2.修改)" />
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText class="kpms-textbox-date" ID="txtWriteDate" runat="server" readonly="readonly" TableName="EPMS_SurveyBrief" Field="WriteDate" ActiveStatus="(2.编制大纲)(2.编制)(2.修改)" />
        </td>
    </tr>
    <tr>
        <td class="td-l">备注</td>
        <td colspan="5" class="td-m">
            <zhongsoft:LightTextBox ID="tbMemo" runat="server" CssClass="kpms-textarea" TextMode="MultiLine" EnableTheming="false" TableName="EPMS_SurveyBrief" Field="Memo" ActiveStatus="(23.编制大纲)(23.编制)(23.修改)" />
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="td-r" colspan="5">
            <zhongsoft:LightFileUploader ID="upLoadFile" runat="server" ActiveStatus="(23.编制大纲)(23.编制)(23.修改)" OnClick="upLoadFile_Click">
                <span>

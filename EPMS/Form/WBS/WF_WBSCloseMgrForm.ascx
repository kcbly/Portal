<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_WBSCloseMgrForm.ascx.cs" Inherits="Zhongsoft.Portal.EPMS.Form.WBS.WBSCloseMgrForm" %>
...
<table class="tz-table" width="100%">
    ...
    <tr>
        ...
        <td class="td-l" style="display: none">升版类型<span class="req-star">*</span>
        </td>
    ...
    <tr>
        ...
        <td class="td-l">执行时间<span class="req-star">*</span>
        </td>
        <td class="td-r">
    ...
    <tr>
        <td class="td-m flexible" colspan="6" onclick="openDetail('trRoll')">卷册信息&nbsp;<img src="../../themes/images/lright.png" />
        </td>
    </tr>
                    ...
                    <asp:TemplateField HeaderText="操作" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center"
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnUp" runat="server" EnableTheming="false" Visible="false"
                                ToolTip="收口版" OnClientClick="return false">
                                    <img alt="收口版" src="../../Themes/Images/btn_shengban.png" 
                                    onclick="upgrade('<%#Eval("OrganizationID") %>','<%#Eval("WBSID") %>','3','<%#Eval("ExecSpecialtyID") %>')"/>
                            </asp:LinkButton>
    ...
    <tr>
        <td class="td-m flexible" colspan="6" onclick="openDetail('trMutual')">互提资料&nbsp;<img src="../../themes/images/lright.png" />
        </td>
    </tr>
    <tr id="trMutual">
        <td class="td-m" colspan="6">
    ...
    <tr>
        <td class="td-m flexible" colspan="6" onclick="openDetail('trExternal')">外部资料&nbsp;<img src="../../themes/images/lright.png" />
        </td>
    </tr>
    <tr id="trExternal">
        <td class="td-m" colspan="6">
...
<script type="text/javascript">
    ...
    function upgrade(orgId, originalId, versionType, execSpecialtyID) {
        var json = { actionType: 2, OrganizationID: orgId, OriginalID: originalId, WBSSplitFormID: '<%=BusinessObjectId %>', VerType: versionType, WBSType: '<%=(int)WBSMode.卷册管理 %>', ExecSpecialtyID: execSpecialtyID };
        if (versionType == '2') {
            json = { actionType: 2, OrganizationID: orgId, OriginalID: originalId, WBSSplitFormID: '<%=BusinessObjectId %>', VerType: versionType, WBSType: '<%=(int)WBSMode.卷册管理 %>', DefaultInhreitType:'<%=(int)InheritType.不继承 %>', ExecSpecialtyID: execSpecialtyID };
        }

<%@ Page Language="C#" AutoEventWireup="true" Title="选择历史项目卷册" MasterPageFile="~/UI/Master/ObjectList.Master"
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <div style="text-align: center;">
        ...
        &nbsp; <span class="req-star" flag="select">请先选择历史项目，再选择卷册</span> <span class="req-star"
            flag="repeat">标红卷册为编号有重复的数据</span>
    </div>
    <!-- 项目类型ID-->

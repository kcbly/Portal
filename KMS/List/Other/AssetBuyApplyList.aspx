<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Master/ObjectList.Master" AutoEventWireup="true" CodeBehind="AssetBuyApplyList.aspx.cs" Inherits="Zhongsoft.Portal.KMS.List.Other.AssetBuyApplyList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="toolBar" runat="server">
    ...
    <span class="filter-block">
        <span class="filter-block-lb">申请购置理由</span>
        <span>
...
<asp:Content ID="Content5" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView ID="gvList" runat="server" UseDefaultDataSource="true" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" BindGridViewMethod="BindData"
        ShowExport="true" ShowPageSizeChange="true" DataKeyNames="AssetBuyApplyFormId" PageSize="15">
        <Columns>
            ...
            <zhongsoft:LightBoundField HeaderText="申请部门" DataField="ApplyDeptName" EditItemClick="viewForm" DataParamFields="AssetBuyApplyFormId"  SortExpression="ApplyDeptName" />
            <zhongsoft:LightBoundField HeaderText="申请日期" DataField="ApplyDate" DataFormatString="{0:yyyy-MM-dd}" SortExpression="ApplyDate"/>
            <zhongsoft:LightBoundField HeaderText="申请购置理由" DataField="Reason" ShowToolTip="true" SortExpression="Reason"/>
            <zhongsoft:LightBoundField HeaderText="申请购置的固定资产要求" DataField="Demand" ShowToolTip="true" SortExpression="Demand" />
            <zhongsoft:LightBoundField HeaderText="数量" DataField="Quantity" SortExpression="Quantity"/>
            <zhongsoft:LightBoundField HeaderText="预计总价" DataField="UnitPrice" SortExpression="UnitPrice"/>

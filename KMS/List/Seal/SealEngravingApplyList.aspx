<%@ Page Title="印章刻制申请台账"  MasterPageFile="~/UI/Master/ObjectWhList.Master" Language="C#" AutoEventWireup="true" CodeBehind="SealEngravingApplyList.aspx.cs" Inherits="Zhongsoft.Portal.KMS.List.Seal.SealEngravingApplyList" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView ID="gvList" runat="server" UseDefaultDataSource="true" AutoGenerateColumns="false" AllowPaging="true" AllowSorting="true" BindGridViewMethod="BindData"
        ShowExport="true" ShowPageSizeChange="true" DataKeyNames="SealEngravingApplyFormId" PageSize="15">
        <Columns>

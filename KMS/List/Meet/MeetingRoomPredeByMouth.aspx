<%@ Page Title="会议室预定月视图台账页" Language="C#" AutoEventWireup="true" CodeBehind="MeetingRoomPredeByMouth.aspx.cs"
    Inherits="Zhongsoft.Portal.KMS.List.Meet.MeetingRoomPredeByMouth" MasterPageFile="~/UI/Master/ObjectWhList.Master" %>

<%@ Register Assembly="DayPilot" Namespace="DayPilot.Web.Ui" TagPrefix="DayPilot" %>
<asp:Content ID="Content3" ContentPlaceHolderID="toolBar" runat="server">
    <span class="filter-block">
        <span class="filter-block-lb">申请人</span><span>
    ...
    <div class="daypilot-main">
        <div class="daypilot-left">
            <DayPilot:DayPilotNavigator ID="DayPilotNavigator1" runat="server" BoundDayPilotID="DayPilotScheduler1"
                SelectMode="Month" CssClassPrefix="navigator_silver_" ShowMonths="1" ClientObjectName="dpn" />
        </div>
        <div class="daypilot-right">
            <div class="pilot-tab">
                <a href="javascript:SelectRoomDay();" >天视图</a>
                <a href="javascript:SelectRoomWeek();">周视图</a>
                <a class="pilot-tablink" href="javascript:SelectRoomMouth();" >月视图</a>
            </div>
            <DayPilot:DayPilotScheduler ID="DayPilotScheduler1" runat="server" ClientObjectName="dp"
                Days="30" CellDuration="1440" CellWidth="100" ShowEventStartEnd="true" Width="95%"
                EventHeight="20" EventFontSize="12px" CssClassPrefix="scheduler_blue" CssOnly="true"
                LoadingLabelBackColor="Silver" Crosshair="Full" BusinessBeginsHour="6"
                BusinessEndsHour="21" DataStartField="MeeStartDate" DataEndField="MeetEndDate"

<%@ Page Title="会议室预定天视图台账页" Language="C#" AutoEventWireup="true" CodeBehind="MeetingRoomPredeByDay.aspx.cs"
    Inherits="Zhongsoft.Portal.KMS.List.Meet.MeetingRoomPredeByDay" MasterPageFile="~/UI/Master/ObjectWhList.Master" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <link href="../../../Themes/DayPilot/DayPilotLayout.css" rel="stylesheet" type="text/css" />
    <link href="../../../Themes/DayPilot/themes.css" rel="stylesheet" type="text/css" />
    ...
    <div class="daypilot-main">
        <div class="daypilot-left">
            <DayPilot:DayPilotNavigator ID="DayPilotNavigator1" runat="server" BoundDayPilotID="DayPilotScheduler1"
                SelectMode="Day" CssClassPrefix="navigator_silver_" ShowMonths="1" ClientObjectName="dpn" />
        </div>
        <div class="daypilot-right">
            <div class="pilot-tab">
                <a class="pilot-tablink" href="javascript:SelectRoomDay();" >天视图</a>
                <a href="javascript:SelectRoomWeek();">周视图</a>
                <a href="javascript:SelectRoomMouth();" >月视图</a>
            </div>
            <DayPilot:DayPilotScheduler ID="DayPilotScheduler1" runat="server" ClientObjectName="dp"
                ShowNonBusiness="false" Days="1" CellDuration="30" CellWidth="40" ShowEventStartEnd="true"
                Width="95%" EventHeight="20" EventFontSize="12px" CssClassPrefix="scheduler_blue"
                CssOnly="true" LoadingLabelBackColor="Silver" Crosshair="Full" BusinessBeginsHour="8"
                BusinessEndsHour="22" DataStartField="MeeStartDate" DataEndField="MeetEndDate"
                DataTextField="MeetingName" DataValueField="MeetingRoomApplyId" DataResourceField="ApplyMeetingRoomIDs"
                ContextMenuID="DayPilotMenu1" EventMoveHandling="CallBack" OnEventMove="DayPilotCalendar1_EventMove"
                OnEventMenuClick="DayPilotCalendar1_EventMenuClick" EventResizeHandling="CallBack"
                OnEventResize="DayPilotCalendar1_EventResize" OnCommand="DayPilotCalendar1_Command"
                EventClickHandling="JavaScript" EventClickJavaScript="eventClick(e);" TimeRangeSelectedHandling="JavaScript"
                TimeRangeSelectedJavaScript="timeRangeSelected(start, end, resource);" OnBeforeEventRender="DayPilotCalendar1_BeforeEventRender"
                AfterRenderJavaScript="afterRender();">
                <TimeHeaders>
                    <DayPilot:TimeHeader GroupBy="Hour"></DayPilot:TimeHeader>
                </TimeHeaders>

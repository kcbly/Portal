<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_TWSendFileForm.ascx.cs" Inherits="Zhongsoft.Portal.KMS.Form.KOA.WF_TWSendFileForm" %>
...
<table class="tz-table" style="border-bottom-width: 0px!important">
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlFileCategory" runat="server" activestatus="(23.拟稿)"
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlFileType" runat="server" activestatus="(23.拟稿)"
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlSecurityLevel" runat="server" activestatus="(23.拟稿)"
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlFileClass" runat="server" activestatus="(23.拟稿)" req="1"
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlPriorityLevel" runat="server" activestatus="(23.拟稿)"
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <asp:LinkButton runat="server" ID="lbtnUploadNew" EnableTheming="False"
                ...
                activestatus="(23.拟稿)(23.套红、盖章)(23.排版)" DisplayStatus="(23.拟稿)(23.套红、盖章)(23.排版)">
    ...
    <tr runat="server" visible="false">
        ...
        <td class="td-r">
            <asp:RadioButtonList ID="rblIsPublishWeb" runat="server" RepeatDirection="Horizontal" needcontrol="true"
                tablename="KMS_KOA_SendFileForm" field="IsPublishWeb" activestatus="(23.拟稿)(23.套红、盖章)">
            </asp:RadioButtonList>
...
<script type="text/javascript">
    function initCustomerPlugin() {
        if ($actCurrId == "act_62646"||$actCurrId == "act_2483") {//套红盖章
            SetAttr2();
        }
        if ($actCurrId == "act_62646"||$actCurrId == "act_2483") {
    ...
    function checkForm() {
        ...
        if ($formAction == 0) {
            if ($actCurrId == "act_60972"||$actCurrId == "act_3609") {

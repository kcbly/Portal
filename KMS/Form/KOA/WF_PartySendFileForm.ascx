<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_PartySendFileForm.ascx.cs" Inherits="Zhongsoft.Portal.KMS.Form.KOA.WF_PartySendFileForm" %>
...
<script type="text/javascript">
    ...
    function checkForm() {
        ...
        if ($formAction == 0) {
            if ($formCtx.actId == "act_65375" || $formCtx.actId == "act_46106") {

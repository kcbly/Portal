<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_PartyReceiveFileForm.ascx.cs" Inherits="Zhongsoft.Portal.KMS.Form.KOA.WF_PartyReceiveFileForm" %>
...
<table class="tz-table">
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightTextBox runat="server" ID="tbFileYear" field="PostFileYear" tablename="KMS_KOA_ReceiveFileForm" regex="^[0-9]*[1-9][0-9]*$" errmsg="请输入正整数"
                CssClass="kpms-textbox" EnableTheming="false" activestatus="(23.填写收文)(23.修改收文)"
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList runat="server" ID="ddlSecurityLevel" field="SecurityLevel"
                tablename="KMS_KOA_ReceiveFileForm" activestatus="(23.填写收文)(23.修改收文)" Width="100px">
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlFileStyle" runat="server" activestatus="(23.填写收文)(23.修改收文)" AutoPostBack="true"
        ...
        <td class="td-r">
            ...
            <zhongsoft:XHtmlInputText ID="tbSerialCode" TableName="KMS_KOA_ReceiveFileForm" Field="SerialCode" runat="server" ActiveStatus="(23.填写收文)(23.修改收文)" class="kpms-textbox" />
    ...
    <tr>
        ...
        <td class="td-m " colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="tbFileTitle" field="FileTitle" tablename="KMS_KOA_ReceiveFileForm"
                ...
                activestatus="(23.填写收文)(23.修改收文)"></zhongsoft:LightTextBox>
        </td>
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="ltbFileDeptName" ActiveStatus="(23.填写收文)(23.修改收文)" req="1"
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightTextBox runat="server" ID="tbFileCode" field="FileCode" tablename="KMS_KOA_ReceiveFileForm"
                ...
                MaxLength="32" activestatus="(23.填写收文)(23.修改收文)"></zhongsoft:LightTextBox>
        </td>
        ...
        <td class="td-r">
            <zhongsoft:LightTextBox runat="server" ID="txtCopies" field="Copies" tablename="KMS_KOA_ReceiveFileForm" MaxLength="3"
                CssClass="kpms-textbox" EnableTheming="false" activestatus="(23.填写收文)(23.修改收文)" regex="^[1-9]\d*$" errmsg="请输入正整数"
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText type="text" runat="server" ID="txtFileDate" tablename="KMS_KOA_ReceiveFileForm" req="1"
                readonly="readonly" class="kpms-textbox-date" field="FileDate" activestatus="(23.填写收文)(23.修改收文)">
            </zhongsoft:XHtmlInputText>
        </td>
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <asp:LinkButton runat="server" ID="lbtnUploadNew" EnableTheming="False" OnClientClick="return uploadFile1('KOAFORM','swfj');" OnClick="lbtnUpload_Click"
                activestatus="(23.填写收文)(23.修改收文)" DisplayStatus="(23.填写收文)(23.修改收文)">
    ...
    <%--<tr>
        ...
        <td class="td-r">
            <asp:RadioButtonList ID="rblIsPublishWeb" runat="server" RepeatDirection="Horizontal" needcontrol="true"
                tablename="KMS_KOA_ReceiveFileForm" field="IsPublishWeb" activestatus="(23.填写收文)(23.修改收文)" req="1">
            </asp:RadioButtonList>
        ...
        <td class="td-m" colspan="3">
            <zhongsoft:LightDropDownList ID="ddlColumn" Width="50%" runat="server"
                tablename="KMS_KOA_ReceiveFileForm" field="ColumnID" ActiveStatus="(23.填写收文)(23.修改收文)">
            </zhongsoft:LightDropDownList>
    ...
    <tr>
        ...
        <td class="td-r" colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="txtProposedOpinion" ActiveStatus="(23.填写收文)(23.修改收文)(23.审核)"
...
<input type="hidden" id="hiCreateUserId" runat="server" field="CreateUserId" tablename="KMS_KOA_ReceiveFileForm" />
<script type="text/javascript">
    function initCustomerPlugin() {
        ...
        //附件不能上传
        try {
            if (!($formCtx.actName == "填写收文" || $formCtx.actName == "修改收文")) {

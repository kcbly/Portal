<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_SendFileForm.ascx.cs" Inherits="Zhongsoft.Portal.KMS.Form.KOA.WF_SendFileForm" %>
...
<table class="tz-table" style="border-bottom-width: 0px!important">
    ...
    <tr>
        ...
        <td class="td-r" colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="tbFileTitle" activestatus="(23.拟稿)(23.文书审核)"
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlFileCategory" runat="server" activestatus="(23.拟稿)(23.文书审核)"
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlFileType" runat="server" activestatus="(23.拟稿)(23.文书审核)"
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlSecurityLevel" runat="server" activestatus="(23.拟稿)(23.文书审核)"
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlFileClass" runat="server" activestatus="(23.拟稿)(23.文书审核)" req="1"
        ...
        <td class="td-r">
            ...
            <zhongsoft:LightTextBox runat="server" ID="txtFileCode" ActiveStatus="(23.套红、盖章)"   
                Field="FileCode" MaxLength="200" tablename="KMS_KOA_SendFileForm" EnableTheming="false"  
                Rows="1" CssClass="kpms-textbox" />
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlPriorityLevel" runat="server" activestatus="(23.拟稿)(23.文书审核)"
    ...
    <tr>
        ...
        <td class="td-r">
            ...
            <zhongsoft:LightTextBox runat="server" ID="txtMainSendDeptName" ActiveStatus="(23.拟稿)(23.文书审核)" req="1"
        ...
        <td class="td-r">
            <zhongsoft:LightTextBox runat="server" ID="tbCopySendDeptName" activestatus="(23.拟稿)(23.文书审核)"
                Field="CopySendDeptName" MaxLength="128" tablename="KMS_KOA_SendFileForm" CssClass="kpms-textbox" EnableTheming="false" />
        </td>
        <td class="td-l">保密期限
        </td>
        <td class="td-r">
            <zhongsoft:LightTextBox runat="server" ID="tbKeepYears" activestatus="(23.拟稿)(23.文书审核)"
    ...
    <tr>
        ...
        <td class="td-r" colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="tbMemo" activestatus="(23.拟稿)(23.文书审核)"
    ...
    <tr>
        ...
        <td class="td-r">
            <input id="tbCreateDate" runat="server" type="text" req="1" class="kpms-textbox-date"
                tablename="KMS_KOA_SendFileForm" field="CreateDate" readonly="readonly" activestatus="(23.拟稿)" /></td>
    </tr>
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <asp:LinkButton runat="server" ID="lbtnUploadNew" EnableTheming="False"
                ...
                activestatus="(23.拟稿)(23.文书审核)(23.套红、盖章)(23.排版)" DisplayStatus="(23.拟稿)(23.文书审核)(23.套红、盖章)(23.排版)">
    ...
    <tr runat="server" visible="false">
        ...
        <td class="td-r">
            ...
            <asp:RadioButtonList ID="rblIsPublishWeb" runat="server" RepeatDirection="Horizontal" needcontrol="true"
                tablename="KMS_KOA_SendFileForm" field="IsPublishWeb" activestatus="(23.拟稿)(23.文书审核)(23.套红、盖章)">
            </asp:RadioButtonList>
    ...
    <tr runat="server" visible="false">
        ...
        <td class="td-r" colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="txtThemeWord" activestatus="(23.拟稿)(23.文书审核)"
...
<script type="text/javascript">
    ...
    function openDocBody(type, action) {
        ...
        if ($actCurrId = "act_25302") {
            actionState = "1";
        }
        //发起人环节也需要保留修订痕迹  除部门接受都可以编辑
        else if ($actCurrId == "act_53091" || $actCurrId == "act_46894" || $actCurrId == "act_26525" || $actCurrId == "act_26442" || $actCurrId == "act_64685" || $actCurrId == "act_44665") {

            actionState = "1";

        }
        else if ($actCurrId == "act_58083") {
            actionState = "4";
        }

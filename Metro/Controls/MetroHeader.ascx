...
<table id="tbHeader" runat="server" style="width: 100%; height: 40px; position: absolute; top: 0px; z-index: 2; background: url(./themes/custom/images/topbg1.png) repeat-x;"
    cellpadding="0" cellspacing="0">
    <tr>
        <td colspan="2" class=" logotitle">
            <img alt="" runat="server" id="imgLogo" src="~/Themes/UserImages/logo.png" />&nbsp;<%=AppConfig.Instance.PortalTitle%>
        </td>

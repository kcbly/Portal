...
<body class=" ">
    ...
    <div class="page-container row-fluid container-fluid">
        ...
        <!--  SIDEBAR - END -->
        <!-- START CONTENT -->
        <section class=" " id="main-content" style="width: 90%; margin-left: 5%;">
            <div class="wrapper main-wrapper row">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <span style="font-size: 1.4em; color: #358dd7; font-family: arialnormal; cursor: pointer">
                                                    <label id="lbZXZContractNum" onclick="openToContract('','','正在执行');"></label>
                                                </span>
                ...
                <div class="col-lg-6">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">近三年新签合同额统计</h2>
                            <div class="actions panel_actions pull-right">
                                <a class="box_toggle fa fa-chevron-down"></a>
                            </div>
                        </header>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="chart-container">
                                        <div id="page_views_three_value" style="height: 240px;"></div>
                ...
                <div class="col-lg-6">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">近三年新签合签订情况统计</h2>
                            <div class="actions panel_actions pull-right">
                                <a class="box_toggle fa fa-chevron-down"></a>
                            </div>
                        </header>
                        <div class="content-body" style="padding: 5px 20px;">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="chart-container">
                                        <div id="page_views_three_qd" style="height: 240px;"></div>
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left">客户累计合同额统计</h2>
                            <div class="actions panel_actions pull-right">
                                <a class="box_toggle fa fa-chevron-down"></a>
                            </div>
                        </header>
                        <div class="content-body" style="padding: 5px 20px;">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="chart-container">
                                        <div id="page_views_customer_amount" style="height: 440px;"></div>
                ...
                <div class="col-lg-12">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left"><%=DateTime.Now.Year %>年度客户合同额统计</h2>
                            <div class="actions panel_actions pull-right">
                                <a class="box_toggle fa fa-chevron-down"></a>
                            </div>
                        </header>
                        <div class="content-body" style="padding: 5px 20px;">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="chart-container">
                                        <div id="page_views_importcustomer_amount" style="height: 440px;"></div>
                ...
                <div class="col-lg-6">
                    <section class="box has-border-left-3">
                        <header class="panel_header">
                            <h2 class="title pull-left"><%=DateTime.Now.Year %>年合同额按合同类型分析</h2>
                            <div class="actions panel_actions pull-right">
                                <a class="box_toggle fa fa-chevron-down"></a>
                            </div>
                        </header>
      ...
      <%--  getCustomer();
                    ...
                    if (data != null && data.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ht += '<div class="trader-buy golden"><h6 class="angle-round" > <i class="fa fa-diamond"></i>' +
                                ...
                                '</h6 ><table class="table-bordered table"><tr><td><span class="dkfxm"><a style="cursor:pointer"  onclick="openToMarketInfo('
                    ...
                    if (data != null && data.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ht += '<tr><th class="table-title"><div style="margin: 0px;"><a style="cursor:pointer"  onclick="viewContractDetail('
                                ...
                                + '\'' + data[i].contractID + '\'' + ');">' + data[i].contractValue + '万</a></td><td><span class="status-pending">'
        ...
        function getProject() {
            $.ajax({
                ...
                success: function (data) {
                    if (data != null && data.length > 0) {
                        var ht = '<table class="table table-striped" id="tech-companies-1" style="margin-bottom: 10px;"><thead> <tr><th>项目名称</th></tr></thead><tbody>';
                        for (var i = 0; i < data.length; i++) {
                            ht += '<tr><th class="table-title"><div style="margin: 0px;"><a style="cursor:pointer"  onclick="viewMarketDetail('
                                ...
                                + data[i].marketProjectName + '">' + data[i].marketProjectName + '</a></div></th> </tr>';
                        }
                        ht += '</tbody></table>';
                        $("#divProject").html(ht);
                    }
        ...
        function getContractInfo() {
            $.ajax({
                ...
                success: function (data) {
                    if (data != "") {
                        $("#lbThisTarget").html(data.NewContract);
                        $("#lbContractValue").html(data.YearContactValue);

                        $("#lbTQContractValue").html(data.ThisQuater);
                        $("#lbTMContractValue").html(data.ThisMonth);
                        $("#lbChargedValue").html(data.receivedValue);
                        $("#lbShouldCharge").html(data.ContractCharge);
                        $("#lbTYChargedTarget").html(data.ContractCharge);
                        $("#lbTQChargedValue").html(data.receivedJDValue);
                        $("#lbTMChargedValue").html(data.receivedMonthValue);

                        var newContract = data.NewContract;
                        var contractRate;
                        if (newContract > 0) {
                            contractRate = parseFloat(data.YearContactValue) / newContract * 100;
                            if (contractRate > 100) {
                                contractRate = 100;
                            }
                        ...
                        var contractCharge = data.ContractCharge;
                        var chargedRate;
                        if (contractCharge > 0) {
                            chargedRate = parseFloat(data.receivedValue) / contractCharge * 100;
                            if (chargedRate > 100) {
                                chargedRate = 100;
                            }
                        }
       ...
       <%-- getStaInfo();
        ...
        function openToCharged(timeType) {
            var url = "<%=WebAppPath%>" + "/MM/List/MCM/ContractReceiveCorpList.aspx";
            initDateScope(timeType);
            url += "?chargeStartDate=" + $startDate + "&chargeEndDate=" + $endDate;
            window.open(url);
            return false;
        ...
        function openToMarketInfo(customerID) {
            ...
            url += "?customerID=" + customerID + "&trackingStates=" +"<%= Zhongsoft.Portal.MM.Entity.MMEnum.TrackingState.跟进.ToString()%>";
            window.open(url);
            return false;
        }
